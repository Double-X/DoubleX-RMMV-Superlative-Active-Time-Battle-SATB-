...
DoubleX_RMMV["Superlative ATB Implementations"] = "v0.01a";
//
...
(function(SATB) {
     ...
     * @returns {Boolean} The check result
     */
    BattleManager.isModuleEnabled = function(module) {
        return this.isSATB() && $gameSystem.satbParamFunc(module)();
    }; // BattleManager.isModuleEnabled
...
(function(SATB) {
    ...
    _SATB._procHandling = function() {
        if (!BattleManager.isModuleEnabled("IsHotkeyEnabled")) return;
