...
DoubleX_RMMV["Superlative ATB Implementations"] = "v0.12a";
//
...
(function(SATB) {
    ...
    _SATB.PARAM_NOTE_FUNCS = {
        params: {
            ...
            atbBarTextPadding: _SATB.ZERO_ARG_FUNC,
            ...
            statusATBBarTextPadding: _SATB.ZERO_ARG_FUNC, // v0.06a+
            ...
            forceATBStatTextPadding: _SATB.ZERO_ARG_FUNC,
            ...
            forceATBRunCmdTextPadding: _SATB.ZERO_ARG_FUNC,
            ...
            forceATBStopCmdTextPadding: _SATB.ZERO_ARG_FUNC,
            ...
            battleTurnClockTextPadding: _SATB.ZERO_ARG_FUNC,
...
(function(SATB) {
    ...
    // v0.12a+; Potential Hotspot
        ...
        var condResultType = _SATB._NOTE_TYPES[note].results[0];
        var unitResultType = _SATB._NOTE_TYPES[note].results[1];
        var intervalResultType = _SATB._NOTE_TYPES[note].results[2];
        return {
            datum: datum,
        ...
        //
    }; // _SATB._COUNTDOWN_PAIR_FUNC
    _SATB._IS_VALID_COUNTDOWN_PAIR = function(note, pair_) {
    // v0.12a+; Potential Hotspot
    ...
    _SATB._NOTE_TYPES = {
        ...
        // (v0.12a+)Countdown Module
        countdown: {
            isValidPair: _SATB._IS_VALID_COUNTDOWN_PAIR,
            pairFunc: _SATB._COUNTDOWN_PAIR_FUNC,
            results: ["bool", "", "num"], // ith element corresponds to suffixi
            runFunc: "_runCountdown_",
     ...
     */
    $._runCountdown_ = function(argObj_, note, pairFunc, latestChainedResult_) {
...
(function(SATB) {
    ...
    _SATB._FIRST_LIST_MONO_FUNC = function(list, note, argObj_) {
     // Potential Hotspot
        return _SATB._LIST_MONO_FUNC(0);
    ...
    _SATB._LAST_LIST_MONO_FUNC = function(list, note, argObj_) {
     // Potential Hotspot
        return _SATB._LIST_MONO_FUNC(list.length - 1);
    ...
    _SATB._NOTE_CHAINING_RULES = {
        ...
        //
        // (v0.12a+)Countdown Module
        countdown: "_countdownNoteChainingRule",
        //
        // (v0.10a+)Rate Module
