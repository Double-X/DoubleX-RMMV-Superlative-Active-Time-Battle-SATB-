...
DoubleX_RMMV["Superlative ATB Implementations"] = "v0.13a";
//
...
(function(SATB) {
    ...
    _SATB.PARAM_NOTE_FUNCS = {
        params: {
            ...
            ctbWinTextPadding: _SATB.ZERO_ARG_FUNC,
...
(function() {
    ...
    Window_SATBCTB.prototype = Object.create(Window_SATBBase.prototype);

    var $ = Window_SATBCTB.prototype, $$ = Window_SATBBase.prototype;
    ...
    $.initialize = function() {
        $$.initialize.call(this, {
            ...
            textPaddingParam: "ctbWinTextPadding",
     ...
     */
    $._formattedText = function() {
        return SATBManager.funcParam.call(this, "ctbWinText", "_text");
    }; // $._formattedText
...
(function(SATB) {
    ...
    _SATB._createAllWins = function() {
        _SATB._createCTBWin.call(this);
        _SATB._createForceWins.call(this);
        _SATB._createTurnClockWin.call(this);
     ...
     * @since v0.13a @version v0.13a
     */
    _SATB._createCTBWin = function() {
        this._satb.wins.ctbWin = new Window_SATBCTB();
        this.addWindow(this._satb.wins.ctbWin);
    }; // _SATB._createCTBWin
    ...
    _SATB._createForceStatusWin = function() {
        this._satb.wins.forceStatusWin = new Window_SATBForceStatus();
        this.addWindow(this._satb.wins.forceStatusWin);
     ...
     * @since v0.11a @version v0.11a
     */
    _SATB._createTurnClockWin = function() {
        this._satb.wins.turnClockWin = new Window_SATBTurnClock();
        this.addWindow(this._satb.wins.turnClockWin);
    }; // _SATB._createTurnClockWin
