...
DoubleX_RMMV["Superlative ATB Unit Tests"] = "v0.13a";
//
    ...
    SATBUT.unitTests = {
        ...
        params: {
            ...
            bar: { // v0.03a+
                ...
                statusATBBarTextPadding: "checkNonnegativeInt",
            ...
            ctb: { // v0.13a+
                ...
                ctbWinTextPadding: "checkNonnegativeInt",
            ...
            turn: { // v0.11a+
                ...
                battleTurnClockTextPadding: "checkNonnegativeInt",
        ...
        testParamArgsWithoutContext: {
            ...
            ctb: { // v0.13a+
                IsCTBEnabled: SATBUT.testNoArgParamFunc,
                isShowCTBWin: SATBUT.testNoArgParamFunc,
                ctbWinText: SATBUT.testNoArgParamFunc,
                ctbWinX: SATBUT.testNoArgParamFunc,
                ctbWinY: SATBUT.testNoArgParamFunc,
                ctbWinW: SATBUT.testNoArgParamFunc,
                ctbWinH: SATBUT.testNoArgParamFunc,
                ctbWinTextSize: SATBUT.testNoArgParamFunc,
                ctbWinLineH: SATBUT.testNoArgParamFunc,
                ctbWinPadding: SATBUT.testNoArgParamFunc,
                ctbWinTextPadding: SATBUT.testNoArgParamFunc,
                ctbWinBackOpacity: SATBUT.testNoArgParamFunc,
                ctbWinTextXOffset: SATBUT.testNoArgParamFunc,
                ctbWinTextYOffset: SATBUT.testNoArgParamFunc
            }, // ctb
            ...
            turn: { // v0.11a+
                IsTurnEnabled: SATBUT.testNoArgParamFunc,
                isShowBattleTurnClockWin: SATBUT.testNoArgParamFunc,
                battleTurnClockText: SATBUT.testNoArgParamFunc,
                battleTurnClockWinX: SATBUT.testNoArgParamFunc,
                battleTurnClockWinY: SATBUT.testNoArgParamFunc,
                battleTurnClockWinW: SATBUT.testNoArgParamFunc,
                battleTurnClockWinH: SATBUT.testNoArgParamFunc,
                battleTurnClockTextSize: SATBUT.testNoArgParamFunc,
                battleTurnClockWinLineH: SATBUT.testNoArgParamFunc,
                battleTurnClockWinPadding: SATBUT.testNoArgParamFunc,
                battleTurnClockTextPadding: SATBUT.testNoArgParamFunc,
                battleTurnClockBackOpacity: SATBUT.testNoArgParamFunc,
                battleTurnClockTextXOffset: SATBUT.testNoArgParamFunc,
                battleTurnClockTextYOffset: SATBUT.testNoArgParamFunc
            } // turn
        }, // testParamArgsWithoutContext
...
(function(SATBUT) {
    ...
    _WSATBBB.lineHeight = $.lineHeight;
    _UT.lineHeight = $.lineHeight = function() { // v0.04a - v0.06a; Extended
        var lineH = _WSATBBB.lineHeight.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._lineHParam]](
                lineH, "_WSATBBB.lineHeight lineH");
        //
        return lineH;
    }; // $.lineHeight

    _WSATBBB.standardFontSize = $.standardFontSize;
    _UT.standardFontSize = $.standardFontSize = function() {
    // v0.04a - v0.06a; Extended
        var textSize = _WSATBBB.standardFontSize.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._textSizeParam]](
                textSize, "_WSATBBB.standardFontSize textSize");
        //
        return textSize;
    }; // $.standardFontSize

    _WSATBBB.standardPadding = $.standardPadding;
    _UT.standardPadding = $.standardPadding = function() {
    // v0.06a - v0.06a; Extended
        var padding = _WSATBBB.standardPadding.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._paddingParam]](
                padding, "_WSATBBB.standardPadding padding");
        //
        return padding;
    }; // $.standardPadding

    _WSATBBB.textPadding = $.textPadding;
    _UT.textPadding = $.textPadding = function() { // v0.04a - v0.06a; Extended
        var textPadding = _WSATBBB.textPadding.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._textPaddingParam]](
                textPadding, "_WSATBBB.textPadding textPadding");
        //
        return textPadding;
    }; // $.textPadding

    _WSATBBB.standardBackOpacity = $.standardBackOpacity;
    _UT.standardBackOpacity = $.standardBackOpacity = function() {
    // v0.04a - v0.06a; Extended
        var opacity = _WSATBBB.standardBackOpacity.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._backOpacityParam]](
                opacity, "_WSATBBB.standardBackOpacity opacity");
        //
        return opacity;
    }; // $.standardBackOpacity

    _WSATBBB.gaugeBackColor = $.gaugeBackColor;
    _UT.gaugeBackColor = $.gaugeBackColor = function() {
    // v0.04a - v0.06a; Extended
        var backColor = _WSATBBB.gaugeBackColor.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._backColorParam]](
                backColor, "_WSATBBB.gaugeBackColor backColor");
        //
        return backColor;
    }; // $.gaugeBackColor
    ...
    _WSATBBB._isVisible = $._isVisible;
    _UT._isVisible = $._isVisible = function() { // v0.04a - v0.06a; Extended
        var isVisible = _WSATBBB._isVisible.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.noteTypes[this._isShowNote]](
                isVisible, "_WSATBBB._isVisible isVisible");
        //
        return isVisible;
    }; // $._isVisible

    _WSATBBB._x = $._x;
    _UT._x = $._x = function() { // v0.04a - v0.06a; Extended
        var x = _WSATBBB._x.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._winXParam]](
                x, "_WSATBBB._x x");
        //
        return x;
    }; // $._x
    ...
    _WSATBBB._y = $._y;
    _UT._y = $._y = function() { // v0.04a - v0.06a; Extended
        var y = _WSATBBB._y.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._winYParam]](
                y, "_WSATBBB._y y");
        //
        return y;
    }; // $._y

    _WSATBBB._opacity = $._opacity;
    _UT._opacity = $._opacity = function() { // v0.06a - v0.06a; Extended
        var opacity = _WSATBBB._opacity.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._opacityParam]](
                opacity, "_WSATBBB._opacity opacity");
        //
        return opacity;
    }; // $._opacity

    _WSATBBB._w = $._w;
    _UT._w = $._w = function() { // v0.04a - v0.06a; Extended
        var w = _WSATBBB._w.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._winWParam]](
                w, "_WSATBBB._w w");
        //
        return w;
    }; // $._w
    ...
    _WSATBBB._h = $._h;
    _UT._h = $._h = function() { // v0.04a - v0.06a; Extended
        var h = _WSATBBB._h.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._winHParam]](
                h, "_WSATBBB._h h");
        //
        return h;
    }; // $._h
    ...
    _WSATBBB._barColor1 = $._barColor1;
    _UT._barColor1 = $._barColor1 = function() { // v0.04a - v0.06a; Extended
        var barColor1 = _WSATBBB._barColor1.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._color1Param]](
                barColor1, "_WSATBBB._barColor1 barColor1");
        //
        return barColor1;
    }; // $._barColor1

    _WSATBBB._barColor2 = $._barColor2;
    _UT._barColor2 = $._barColor2 = function() { // v0.04a - v0.06a; Extended
        var barColor2 = _WSATBBB._barColor2.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._color2Param]](
                barColor2, "_WSATBBB._barColor2 barColor2");
        //
        return barColor2;
    }; // $._barColor2

    _WSATBBB._atbTextColor = $._atbTextColor;
    _UT._atbTextColor = $._atbTextColor = function() {
    // v0.04a - v0.06a; Extended
        var textColor = _WSATBBB._atbTextColor.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._textColorParam]](
                textColor, "_WSATBBB._atbTextColor textColor");
        //
        return textColor;
    }; // $._atbTextColor

    _WSATBBB._textXOffset = $._textXOffset;
    _UT._textXOffset = $._textXOffset = function() {
    // v0.04a - v0.06a; Extended
        var textX = _WSATBBB._textXOffset.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._textXParam]](
                textX, "_WSATBBB._textXOffset textX");
        //
        return textX;
    }; // $._textXOffset

    _WSATBBB._textYOffset = $._textYOffset;
    _UT._textYOffset = $._textYOffset = function() {
    // v0.04a - v0.06a; Extended
        var textY = _WSATBBB._textYOffset.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._textYParam]](
                textY, "_WSATBBB._textYOffset textY");
        //
        return textY;
    }; // $._textYOffset
...
})(DoubleX_RMMV.SATB.Unit_Tests); // Window_SATBBarBase
