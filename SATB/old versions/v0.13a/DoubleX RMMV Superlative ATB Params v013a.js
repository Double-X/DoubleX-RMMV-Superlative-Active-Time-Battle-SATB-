...
DoubleX_RMMV["Superlative ATB Parameters"] = "v0.13a";
//
 ...
 * @default "return 8;"
 *
 * @param ctbWinTextPadding
 * @parent IsCTBEnabled
 * @type note
 * @desc Sets the text padding of the CTB window
 * It'll be the contents of a function returning an Integer
 * @default "return 4;"
 *
 ...
 * It'll be contents of a function returning a Number
 * @default "return this.latestSATBItem_.speed;"
 *
 ...
 * @default "return 8;"
 *
 * @param battleTurnClockTextPadding
 * @parent IsTurnEnabled
 * @type note
 * @desc Sets the padding of the text showing the battle turn clock
 * It'll be the contents of a function returning an Integer
 * @default "return 4;"
 *
 ...
 *      9. ctbWinLineH
 *      10. ctbWinPadding
 *      11. ctbWinTextPadding
 *      12. ctbWinBackOpacity
 *          You'll likely have to experimenet this yourselves to find values
 *          that suit your needs
 *          THE FUNCTION USED BY THIS PARAMETER SHOULD BE PERFORMANT ENOUGH TO
 *          BE RUN PER FRAME SO THIS PARAMETER SHOULD BE EASY, SIMPLE AND
 *          SMALL UNLESS _isParamFuncCached IS ON
 *      13. ctbWinTextXOffset
 ...
 *         BE RUN PER FRAME SO THIS PARAMETER SHOULD BE EASY, SIMPLE AND
 *         SMALL UNLESS _isParamFuncCached IS ON
 *      6. battleTurnClockWinW
 *      7. battleTurnClockWinH
 *      8. battleTurnClockTextSize
 *      9. battleTurnClockWinLineH
 *      10. battleTurnClockWinPadding
 *      11. battleTurnClockTextPadding
 *      12. battleTurnClockBackOpacity
 *          You'll likely have to experimenet this yourselves to find values
 *          that suit your needs
 *          THE FUNCTION USED BY THIS PARAMETER SHOULD BE PERFORMANT ENOUGH TO
 *          BE RUN PER FRAME SO THIS PARAMETER SHOULD BE EASY, SIMPLE AND
 *          SMALL UNLESS _isParamFuncCached IS ON
 *      13. battleTurnClockTextXOffset
 ...
 *      (v0.13a+)CTB Module
 *      1. IsCTBEnabled
 *         Setting IsCTBEnabled as return false; will disable the CTB Module
 *         but the CTB window will still be shown if isShowCTBWin returns a
 *         truthy result
 *      2. isShowCTBWin
 ...
 *      3. actSpeed
 *         Setting actSpeed as return this.latestSATBItem_.speed; will set the
 *         action speed for the battler involved to be the original skill/item
 *         invocation speed
 *      (v0.09a+)Start Module
 *      1. IsStartEnabled
