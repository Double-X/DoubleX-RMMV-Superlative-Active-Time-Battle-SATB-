 ...
 *      5. (v0.01a+) DoubleX RMMV Superlative ATB(Core And Wait Module Only)
 ...
 *            be used
 *      14. (Advanced)raiseAllSATBNoteChangeFactors()
 ...
 *      15. (Advanced)raiseSATBNoteChangeFactors(note, factors)
 ...
 *      16. (Advanced)invalidateSATBNoteResult(note, part)
 ...
 *      17. (Advanced)invalidateSATBNoteList(note, part)
...
DoubleX_RMMV["Superlative ATB Documentations"] = "v0.02a";
//

// Ensures that all plugins are of the latest version
DoubleX_RMMV.SATB_VERS = {
    Parameters: "0.02a",
    Configurations: "0.02a",
    Implementations: "0.02a",
    "Unit Tests": "0.02a",
    Compatibilities: "0.02a",
