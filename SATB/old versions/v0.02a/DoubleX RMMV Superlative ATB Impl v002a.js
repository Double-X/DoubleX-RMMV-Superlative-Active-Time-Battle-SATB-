...
DoubleX_RMMV["Superlative ATB Implementations"] = "v0.02a";
//
...
function Window_SATBBase() {
    "use strict";
    this.initialize.apply(this, arguments);
} // Window_SATBBase(v0.02a+)
//
function Window_SATBForceRunCmd() {
    "use strict";
    this.initialize.apply(this, arguments);
} // Window_SATBForceRunCmd(v0.02a+)
function Window_SATBForceStopCmd() {
    "use strict";
    this.initialize.apply(this, arguments);
} // Window_SATBForceStopCmd(v0.02a+)
function Window_SATBForceStatus() {
    "use strict";
    this.initialize.apply(this, arguments);
} // Window_SATBForceStatus(v0.02a+)
...
(function(SATB) {
     ...
     * @enum @param {Param} module - The module parameter name
     * @returns {Boolean} The check result
     */
    BattleManager.isSATBModuleEnabled = function(module) {
        return this.isSATB() && $gameSystem.satbParamFunc(module)();
    }; // BattleManager.isSATBModuleEnabled
     ...
     * @interface @since v0.01a @version v0.01a
     */
    BattleManager.satbCoreTurnClockUnit = function() {
        ...
        //
    }; // BattleManager.satbCoreTurnClockUnit
    ...
    _SATB._procTurn = function() {
        if (_SATB._isActPhase.call(this)) return;
     ...
     * The this pointer is BattleManager
     * Potential Hotspot
     * @since v0.00a @version v0.01a
     * @param {String} clockUnit - The ATB turn clock unit(act/frame/sec)
     * @param {Number} clockMax - The ATB turn clock maximum value
     * @param {(Number)} overflowFunc - Function to run when turn clock overflow
     */
    _SATB._onMaxCoreTurnClock = function(clockUnit, clockMax, overflowFunc) {
        if (this.satbCoreTurnClockUnit(this) !== clockUnit) return;
...
(function(SATB) {
    ...
    _SATB._INVALIDATE_PARAM_CACHE = function() {
    ...
    _SATB.PARAM_NOTE_FUNCS = {
        params: {
            ...
            forceATBStatTranslucentOpacity: _SATB._0_ARG_FUNC,
            ...
            forceATBRunCmdTranslucentOpacity: _SATB._0_ARG_FUNC,
            ...
            forceATBStopCmdTranslucentOpacity: _SATB._0_ARG_FUNC,
        ...
        notes: {
            ...
            coreActState: function(content) { // Potential Hotspot
                var c = "'use strict';\n" + content;
    ...
    _SATB._PARAM_UPDATES = {
        // Core Module
        coreBaseFillATBFrame: _SATB._INVALIDATE_PARAM_CACHE,
        coreBaseFillATBSec: _SATB._INVALIDATE_PARAM_CACHE,
        coreTurnATBTime: _SATB._INVALIDATE_PARAM_CACHE,
        coreTurnATBAct: _SATB._INVALIDATE_PARAM_CACHE,
        canCoreTurnClockOverflow: _SATB._INVALIDATE_PARAM_CACHE,
    ...
    _SATB._JSON_PARAMS = [
        ...
        "forceATBStatTranslucentOpacity",
        ...
        "forceATBRunCmdTranslucentOpacity",
        ...
        "forceATBStopCmdTranslucentOpacity",
    ...
    _SATB._PARAM_MODULES = {
        ...
        forceATBStatTranslucentOpacity: "wait",
        ...
        forceATBRunCmdTranslucentOpacity: "wait",
        ...
        forceATBStopCmdTranslucentOpacity: "wait",
...
(function(SATB) {
    ...
    $.eraseCoreSATBActs = function() {
        this.clearCoreSATB();
        // setSATBActTimes isn't called for performance boost
...
(function(SATB) {
    ...
    $.addSATBActTimes = function(increment) {
        this.setSATBActTimes(this._satb.actTimes + increment);
    }; // $.addSATBActTimes
    ...
    $.multiplySATBActTimes = function(multiplier) {
        this.setSATBActTimes(this._satb.actTimes * multiplier);
...
(function(SATB) {
    ...
    $.coreATBProportion = function() {
        ...
        return this.coreATB() * 1.0 / this.coreMax();
        //
    }; // $.coreATBProportion
...
(function(SATB) {
    ...
    // {Param} _translucentOpacityParam: Parameter returning translucent opacity
     ...
     */
    $.lineHeight = function() {
        return $gameSystem.satbParamFunc(this._lineHParam)();
    }; // $.lineHeight
    ...
    $.standardFontSize = function() {
        return $gameSystem.satbParamFunc(this._textSizeParam)();
    }; // $.standardPadding
    ...
    $.standardPadding = function() {
        return $gameSystem.satbParamFunc(this._paddingParam)();
    }; // $.standardPadding
    ...
    $.textPadding = function() {
        return $gameSystem.satbParamFunc(this._textPaddingParam)();
    }; // $.textPadding
    ...
    $.standardBackOpacity = function() {
        return $gameSystem.satbParamFunc(this._backOpacityParam)();
    }; // $.standardBackOpacity
     ...
     * Hotspot/Nullipotent
     * @interface @since v0.02a @version v0.02a
     * @returns {Opacity} The translucent opacity of this window
     */
    $.translucentOpacity = function() {
        return $gameSystem.satbParamFunc(this._translucentOpacityParam)();
    }; // $.translucentOpacity
    ...
    $._setWinBaseParams = function(winBaseParams) {
        ...
        this._translucentOpacityParam = winBaseParams.translucentOpacityParam;
     ...
     */
    $._isVisible = function() {
        if (!BattleManager.isSATBModuleEnabled(this._moduleParam)) return false;
        return $gameSystem.satbParamFunc(this._isShowParam)();
    }; // $._isVisible
     ...
     * @since v0.02a @version v0.02a
     */
    $._updateXYWH = function() {
        var xywh = this._xywh();
        ["x", "y", "width", "height"].forEach(function(spec) {
            if (this[spec] !== xywh[spec]) this[spec] = xywh[spec];
        }, this);
    }; // $._updateXYWH
    ...
    $._xywh = function() {
        return {
            x: $gameSystem.satbParamFunc(this._winXParam)(),
            y: $gameSystem.satbParamFunc(this._winYParam)(),
            width: $gameSystem.satbParamFunc(this._winWParam)(),
            height: $gameSystem.satbParamFunc(this._winHParam)()
        }
    }; // $._xywh
    ...
    $._updateText = function() {
        var x = this._textX;
        this._textX = this._textXOffset();
        var isUpdateX = x !== this._textX;
        var y = this._textY;
        this._textY = this._textYOffset();
        var isUpdateY = y !== this._textY;
        var size = this._textSize;
        this._textSize = this.standardFontSize();
        var isUpdateSize = size !== this._textSize;
        var padding = this._padding;
        this._padding = this.standardPadding();
        var isUpdatePadding = padding !== this._padding;
        var textPadding = this._textPadding;
        this._textPadding = this.textPadding();
        var isUpdateTextPadding = textPadding !== this._textPadding;
        var text = this._text;
        this._text = this._formattedText();
        var isUpdateText = text !== this._text;
        if (!isUpdateX && !isUpdateY && !isUpdateSize && !isUpdateText &&
                !isUpdatePadding && !isUpdateTextPadding) return;
    ...
    $._textXOffset = function() {
        console.warn("The abstract method _textXOffset isn't implemented by" +
                this.constructor);
        return 0;
    }; // $._textXOffset
    ...
    $._textYOffset = function() {
        console.warn("The abstract method _textYOffset isn't implemented by" +
                this.constructor);
        return 0;
    }; // $._textYOffset
...
(function(SATB) {
    ...
    $.initialize = function(onForceRun) {
        ...
        $$.initialize.call(this, {
            ...
            translucentOpacityParam: "forceATBRunCmdTranslucentOpacity",
     ...
     * @since v0.02a @version v0.02a
     */
    $._updateWhenVisible = function() { this._updateText(); };
     ...
     */
    $._textXOffset = function() {
        return $gameSystem.satbParamFunc("forceATBRunCmdTextXOffset")();
    }; // $._textXOffset
     ...
     */
    $._textYOffset = function() {
        return $gameSystem.satbParamFunc("forceATBRunCmdTextYOffset")();
    }; // $._textYOffset
     ...
     */
    $._formattedText = function() {
        return $gameSystem.satbParamFunc("forceRunATBCmdText")();
    }; // $._formattedText
     ...
     * @since v0.02a @version v0.02a
     */
    $._onTouch = function() { this._onForceRun(); };
...
(function(SATB) {
    ...
    $.initialize = function(onForceStop) {
        ...
        $$.initialize.call(this, {
            ...
            translucentOpacityParam: "forceATBStopCmdTranslucentOpacity",
            moduleParam: "IsWaitEnabled",
     ...
     */
    $._textXOffset = function() {
        return $gameSystem.satbParamFunc("forceATBStopCmdTextXOffset")();
    }; // $._textXOffset
     ...
     */
    $._textYOffset = function() {
        return $gameSystem.satbParamFunc("forceATBStopCmdTextYOffset")();
    }; // $._textYOffset
     ...
     */
    $._formattedText = function() {
        return $gameSystem.satbParamFunc("forceStopATBCmdText")();
    }; // $._formattedText
     ...
     * @since v0.02a @version v0.02a
     */
    $._onTouch = function() { this._onForceStop(); };
...
(function(SATB) {
    ...
    $.initialize = function() {
        ...
        $$.initialize.call(this, {
            ...
            translucentOpacityParam: "forceATBStatTranslucentOpacity",
            moduleParam: "IsWaitEnabled",
     ...
     */
    $.onForceRun = function() {
        if (this.isForceStop()) return this._forceState = "";
        this._forceState = _SATB._FORCE_RUN;
    }; // $.onForceRun
    ...
    $.onForceStop = function() {
        if (this.isForceRun()) return this._forceState = "";
        this._forceState = _SATB._FORCE_STOP;
    }; // $.onForceStop
     ...
     */
    $._updateAll = function() {
        if (this._isForceRunKeyTriggered()) return this.onForceRun();
        if (this._isForceStopKeyTriggered()) this.onForceStop();
    }; // $._updateAll
     ...
     */
    $._textXOffset = function() {
        return $gameSystem.satbParamFunc("forceATBStatTextXOffset")();
    }; // $._textXOffset
     ...
     */
    $._textYOffset = function() {
        return $gameSystem.satbParamFunc("forceATBStatTextYOffset")();
    }; // $._textYOffset
     ...
     */
    $._formattedText = function() {
        return $gameSystem.satbParamFunc(this._textParam())();
    }; // $._formattedText
...
(function(SATB) {
    ...
    $.isRunSATBFrameUpdate = function() {
        // It's better to keep these codes here than extracting them out
        if (BattleManager.isSATBModuleEnabled("IsWaitEnabled")) {
    ...
    $.refreshSATBInputWins = function() {
        ...
        if (this._actorWindow.visible) return _SATB._refreshDeselectTargetWin(
                this._actorWindow, this._enemyWindow);
        if (this._enemyWindow.visible) return _SATB._refreshDeselectTargetWin(
    ...
    _SATB._createForceWins = function() {
        ...
        var forceStatusWin = this._satb.forceStatusWin;
        _SATB._createForceRunCmdWin.call(this, forceStatusWin);
        _SATB._createForceStopCmdWin.call(this, forceStatusWin);
     ...
     * The this pointer is Scene_Battle.prototype
     * @since v0.02a @version v0.02a
     * @param {Window_SATBForceStatus} forceStatusWin - The ATB force status win
     */
    _SATB._createForceRunCmdWin = function(forceStatusWin) {
        this._satb.forceRunCmdWin = new Window_SATBForceRunCmd(
                forceStatusWin.onForceRun.bind(forceStatusWin));
     ...
     * @param {Window_SATBForceStatus} forceStatusWin - The ATB force status win
     */
    _SATB._createForceStopCmdWin = function(forceStatusWin) {
        this._satb.forceStopCmdWin = new Window_SATBForceStopCmd(
                forceStatusWin.onForceStop.bind(forceStatusWin));
    ...
    _SATB._onTrySelectPrevNextActorByHotkey = function(sign) {
        var inputableIndices = BattleManager.inputableSATBActorIndices();
        if (!_SATB._canSelectPrevNextActorByHotkey.call(
                this, inputableIndices)) return SoundManager.playBuzzer();
     ...
     * @returns {Boolean} The check result
     */
    _SATB._canSelectPrevNextActorByHotkey = function(inputableIndices) {
    ...
    }; // _SATB._canSelectPrevNextActorByHotkey
    ...
    _SATB._onSelectPrevNextActorByHotkey = function(sign, inputableIndices) {
        ...
        var newInputableIndex = _SATB._newInputableActorIndexFromHotkey.call(
                this, sign, inputableIndices);
     ...
     */
    _SATB._newInputableActorIndexFromHotkey = function(sign, inputableIndices) {
    ...
    }; // _SATB._newInputableActorIndexFromHotkey
    ...
    _SATB._onTrySelectActorIndexByHotkey = function(i) {
        ...
        if (!_SATB._canSelectActorIndexByHotkey.call(this, newActor_)) {
     ...
     * Potential Hotspot/Nullipotent
     * @since v0.01a @version v0.01a
     * @param {Game_Actor?} newActor_ - The actor to be selected to input action
     * @returns {Boolean} The check result
     */
    _SATB._canSelectActorIndexByHotkey = function(newActor_) {
        if (BattleManager.actor() === newActor_) return false;
        return BattleManager.canInputSATB(newActor_);
    }; // _SATB._canSelectActorIndexByHotkey
     ...
     */
    _SATB._refreshDeselectTargetWin = function(refreshWin, deselectWin) {
        refreshWin.refresh();
