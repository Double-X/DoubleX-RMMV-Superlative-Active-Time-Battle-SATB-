...
DoubleX_RMMV["Superlative ATB Implementations"] = "v0.14a";
//
...
(function() {
     ...
     * @returns {Array} - The fully filtered array from this
     */
     ...
     * @returns {Array} - The fully reduced array result from this
     ...
     * @param {(*, <T>, Index, [<T>]) -> *} mapCallback - The callback in the
     *                                                    Array map method
     * @param {(*, <T>, Indexx, [<T>]) -> Boolean} someCallback - The callback
     *                                                            in the
     *                                                            Array some
     *                                                            method
     * @param {*?} mapThis_ - The context of mapCallback
     * @param {*?} someThis_ - The context of someCallback
     * @returns {Array} - The fully mapped array then applied some from this
     */
...
(function(SATB) {
    ...
    $.baseCoreMaxSATB = function() {
        ...
        var param = "coreMaxATBVal";
        var cache = "_cachedBaseCoreMax_";
    ...
    $.baseChargeMaxSATB = function() {
        ...
        if (!$gameSystem.satbParam("_isParamFuncCached")) {
            ...
            //
        } else if (!SATBM.IS_VALID_RESULT(this._satb._cachedBaseChargeMax_)) {
            this._satb._cachedBaseChargeMax_ = $gameSystem.satbParamFunc(
                    "chargeMaxATBVal").call(this, this.coreMaxSATB());
        }
        return this._satb._cachedBaseChargeMax_;
        //
    }; // $.baseChargeMaxSATB
    ...
    $.baseCooldownMaxSATB = function() {
        ...
        if (!$gameSystem.satbParam("_isParamFuncCached")) {
            ...
            return $gameSystem.satbParamFunc("cooldownMaxATBVal").call(
                    this, this.coreMaxSATB());
            //
        } else if (!SATBM.IS_VALID_RESULT(this._satb._cachedBaseCooldownMax_)) {
            this._satb._cachedBaseCooldownMax_ = $gameSystem.satbParamFunc(
                    "cooldownMaxATBVal").call(this, this.coreMaxSATB());
        }
        return this._satb._cachedBaseCooldownMax_;
        //
    }; // $.baseCooldownMaxSATB
