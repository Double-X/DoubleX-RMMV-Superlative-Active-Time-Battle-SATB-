 ...
 *         DoubleX RMMV Superlative ATB Params v015a
 ...
 *         manager upon using a newer parameter plugin version, you can do
 *         the following:
 *         - Renames the newer version of the parameter plugin to be that of
 *           the older version
 *         - Edits the value of DoubleX_RMMV.Superlative_ATB_Parameters_File
 *           to be the filename of the older version, which must be done via
 *           opening the parameter plugin js file directly
...
DoubleX_RMMV["Superlative ATB Documentations"] = "v0.15a";
//
