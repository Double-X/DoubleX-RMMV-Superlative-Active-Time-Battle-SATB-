 ...
 *         DoubleX RMMV Superlative ATB Params v004a
 ...
 *            be used
 *      16. (Advanced)raiseAllSATBNoteChangeFactors()
 ...
 *      17. (Advanced)raiseSATBNoteChangeFactors(note, factors)
 ...
 *      18. (Advanced)invalidateSATBNoteResult(note, part)
 ...
 *      19. (Advanced)invalidateSATBNoteList(note, part)
 ...
 *           one returns the charge ATB instead
 *============================================================================
 *    ## Plugin Command Info
...
DoubleX_RMMV["Superlative ATB Documentations"] = "v0.04a";
//

// Ensures that all plugins are of the latest version
DoubleX_RMMV.SATB_VERS = {
    Parameters: "0.04a",
    Configurations: "0.04a",
    Implementations: "0.04a",
    "Unit Tests": "0.04a",
