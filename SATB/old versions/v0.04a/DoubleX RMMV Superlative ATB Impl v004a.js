...
DoubleX_RMMV["Superlative ATB Implementations"] = "v0.04a";
//
 ...
 *           (Thorough comprehension on RMMV plugin development with at least
 *           1 advanced complex high quality plugin written without nontrivial
 *           bugs up to 10000 LoC scale and being a veteran with significant
 *           number of plugin users)
 ...
 *    # Adding new modules:
 *      1. Add them in _SATB._initContainers in Game_System in the
 ...
 *         - _SATB._initContainers in Game_System
...
(function(SATB) {
    ...
    // v0.00a - v0.00a; Extended
        ...
        if (SATBManager.isEnabled()) {
            return _SATB._hasInputableActors.call(this);
        }
        //
    ...
    // v0.00a - v0.00a; Extended
        ...
        _SATB._onUpdateActorSelect.call(this);
        //
    ...
    ["processVictory", "processDefeat"].forEach(function(func) {
        ...
        // v0.00a - v0.00a; Extended
            ...
            _SATB._procScene_.call(this, "closeSATBInputWins");
            //
     ...
     * @returns {Boolean} The check result
     */
    BattleManager.isUnselectedSATBInputableActor = function(actor_) {
        if (this.actor() === actor_) return false;
        return this.canInputSATB(actor_);
    }; // BattleManager.isUnselectedSATBInputableActor

    /**
     * Hotspot/Nullipotent
     * @interface @since v0.01a @version v0.01a
     * @param {Game_Actor} actor - The actor to have the inputability checked
     * @returns {Boolean} The check result
     */
    BattleManager.canInputSATB = function(actor) {
        return this._satb.inputableActors.contains(actor);
     ...
     */
    _SATB._onUpdateActorSelect = function() {
        this._satb.isUpdateActorSelect = true;
    }; // _SATB._onUpdateActorSelect
    ...
    _SATB._refreshStatus = function() {
        ...
        _SATB._procScene_.call(this, "refreshSATBInputWins");
        //
    ...
    _SATB._checkIsRefreshNeeded = function() {
        ...
        this._satb.isRefreshNeeded = false;
        _SATB._procScene_.call(this, "refreshStatus");
     ...
     */
    _SATB._procScene_ = function(func) {
        // It serves as a helper function for calling Scene_Battle functions
        if ($gameParty.inBattle()) return SceneManager._scene[func]();
        //
    }; // _SATB._procScene_
...
(function(SATB) {
    ...
    var _SATB = SATB.SATBTurnManager = {}, SATBM = SATB.SATBManager;

    // A new clean object must be returned or this clean state would be lost
    _SATB._CORE_TURN_CLOCK = function() { // Potential Hotspot
    ...
    //                                         counter
    // {+ve Number?} _coreTurnSecClockMax_: The Turn clock maximum second
    ...
    SATBTurnManager.init = function() {
        this._coreTurnClock = _SATB._CORE_TURN_CLOCK();
    }; // SATBTurnManager.init
     ...
     */
    SATBTurnManager.multiplyTurnClockAct = function(multiplier) {
     ...
     */
    SATBTurnManager.multiplyTurnClockFrame = function(multiplier) {
        // The action counter will be corrected to be an integer later
     ...
     */
    SATBTurnManager.multiplyTurnClockSec = function(multiplier) {
        this.addCoreTurnClockSec(this._coreTurnClock.sec * (multiplier - 1));
     ...
     */
    SATBTurnManager.setTurnClockAct = function(act) {
     ...
     */
    SATBTurnManager.setTurnClockFrame = function(frame) {
     ...
     */
    SATBTurnManager.setTurnClockSec = function(sec) {
        this.addCoreTurnClockSec(sec - this._coreTurnClock.sec);
     ...
     * Script Call/Potential Hotspot/Nullipotent
     * @interface @since v0.04a @version v0.04a
     * @return @enum {ClockUnit} The battle turn clock counter unit
     */
    SATBTurnManager.coreTurnClockUnit = function() {
        ...
        switch ($gameSystem.satbParam("_coreTurnUnit")) {
            ...
            default: return "";
            /** @todo Refactors this nested switches into a cleaner version */
        }
        //
    ...
    SATBTurnManager.updateCoreTurnByTime = function() {
        switch ($gameSystem.satbParam("_coreBaseFillUnit")) {
            ...
            case "coreBaseFillATBSec": {
                ...
                return this.addCoreTurnClockSec(incrementMs);
            }
            //
        }
    }; // SATBTurnManager.updateCoreTurnByTime
    ...
    /**
     * The this pointer is SATBTurnManager
     * Hotspot
     * @since v0.04a @version v0.04a
     * @param {Int} increment - The action ATB turn clock increment
    ...
    _SATB._updateCoreTurnClock = function(increment, isInt, clockUnit, clockMax, overflowFunc) {
        ...
        _SATB._onMaxCoreTurnClock.call(this, clockUnit, clockMax, overflowFunc);
     ...
     * @param {(Number)} overflowFunc - Function to run when turn clock overflow
     */
    _SATB._onMaxCoreTurnClock = function(clockUnit, clockMax, overflowFunc) {
        ...
        if (_SATB._canCoreTurnClockOverflow.call(this)) {
            ...
            //
        } else this._coreTurnClock = _SATB._CORE_TURN_CLOCK();
        //
        BattleManager.endTurn();
...
(function(SATB) {
    ...
    SATBManager.invalidateParamCache = function() {
        ...
        if ($gameParty && $gameParty.inBattle()) BattleManager.refreshStatus();
        //
    ...
    SATBManager.updateNoteDefault = function(note, switchVar_, id_, dataTypes_) {
        ...
        BattleManager.raiseSATBMemNoteChangeFactors(note, ["result"]);
        //
    ...
    SATBManager.updateNoteChainingRule = function(note) {
        BattleManager.raiseSATBMemNoteChangeFactors(note, ["chainingRule"]);
    ...
    SATBManager.updateNotePriorities = function(note) {
        BattleManager.raiseSATBMemNoteChangeFactors(note, ["priority"]);
...
(function(SATB) {
    ...
    _SATB._PARAM_UPDATES = {
        ...
        //
        // (v0.04a+)Bar Module
        isBarVisible: SATBManager.updateNoteDefault.bind(
        ...
        _canCancelChargeNoteChainingRule: SATBManager.updateNotePriorities.
                bind(SATBManager, "canCancelCharge"),
        _canCancelChargeNotePriorities: SATBManager.updateNoteChainingRule.
                bind(SATBManager, "canCancelCharge"),
        ...
        _canForceChargeNotePriorities: SATBManager.updateNoteChainingRule.
                bind(SATBManager, "canForceCharge")
        //
    }; // _SATB._PARAM_UPDATES
    ...
    _SATB._CACHED_DEFAULT_NOTE_PARAMS = {
        coreMaxATBVal: "coreMax",
        isShowATBBar: "isBarVisible",
    ...
    _SATB._initContainers = function() {
        this._satb = {
            params: { core: {}, bar: {}, hotkey: {}, wait: {}, charge: {} },
            notes: {
                coreMax: {},
                coreActState: {},
                isBarVisible: {},
...
(function(SATB) {
    ...
    _SATB._refresh = function() {
        ...
        if (SATBManager.isEnabled()) _SATB._checkUpdatedResults.call(this);
        //
    }; // _SATB._refresh
...
(function(SATB) {
    ...
    _GB.useItem = $.useItem;
    _SATB.useItem = $.useItem = function(item) {
    // v0.04a - v0.04a; Extended
    ...
    $.initSATBNotes = function() {
        // notes must be setup first as phaseTypes will access notes via battler
     ...
     * Hotspot/Nullipotent
     * @interface @since v0.00a @version v0.00a
     * @returns {+ve Number} Base maximum ATB value of the battler involved
     */
    $.baseCoreMaxSATB = function() {
        ...
        if (!$gameSystem.satbParam("_isParamFuncCached")) {
            ...
            //
        } else if (!SATBM.IS_VALID_RESULT(this._satb.cachedBaseCoreMax_)) {
     ...
     * Hotspot/Nullipotent
     * @interface @since v0.00a @version v0.00a
     * @returns {+ve Number} Base Maximum ATB charge value of battler involved
     */
    ...
    $.didSATBInput = function() {
        ...
        // The ordering must be this or latestSATBItem_ would be undefined
     ...
     * @interface @since v0.00a @version v0.04a
     */
    $.onBecomeActable = function() { BattleManager.addSATBActBattler(this); };

    /**
     * Idempotent
     * @interface @since v0.00a @version v0.04a
     */
    $.onBecomeNotActable = function() {
...
(function(SATB) {
     ...
     */
    $.setCurATB = function(val) { this._setATB(val, this._phase); };
    ...
    $.setChargeATB = function(val) {
        ...
        if (val < 0) return this._battler.onCancelSATBCharge();
        //
     ...
     */
    $.curATB = function() { return this._atbs[this._phase]; };
     ...
     * Script Call/Hotspot/Idempotent
     * @interface @since v0.04a @version v0.04a
     * @returns {+ve Number} The current maximum ATB value of the battler
     */
     ...
     * Script Call/Idempotent
     * @interface @since v0.04a @version v0.04a
     * @returns {+ve Number} The current ATB fill proportion of the battler
     */
     ...
     * Script Call/Idempotent
     * @interface @since v0.00a @version v0.04a
     * @returns {+ve Number} The ATB fill proportion of the battler
     */
     ...
     * Script Call/Idempotent
     * @interface @since v0.04a @version v0.04a
     * @returns {+ve Number} The charge ATB fill proportion of the battler
     */
    ...
    $.checkUpdatedMaxes = function() {
        // The norm phase must be checked first as it might clear charge ATB val
        this._checkUpdatedMax(
                this.coreATB(), _SATB._PHASE_NORM, this._battler.coreMaxSATB());
        //
        if (this._phase !== _SATB._PHASE_CHARGE) return;
        this._checkUpdatedMax(
                this.chargeATB(), this._phase, this._battler.chargeMaxSATB());
    }; // $.checkUpdatedMaxes
    ...
    $._fillChargeATB = function(fillRate) {
        ...
        if (!this._battler.isChargeItem()) return this.fillUpChargeATB();
        //
    ...
    $._onChargeATBBecomeFull = function() {
        if (this._forceChargeState !== _SATB._FORCE_CHARGE) {
            return this._battler.onBecomeActable();
        }
        if (SATBManager.areModulesEnabled(["IsChargeEnabled"])) return;
        this._battler.onBecomeActable();
    ...
    $._onChargeATBBecomeNotFull = function() {
        ...
        /** @todo Extracts this into a meaningful Game_Battler method */
...
(function(SATB) {
    ...
    $._partResults = function(note, argObj_, funcNameSuffix) {
        ...
        return priorities.mapFilter(resultFunc, SATBM.IS_VALID_RESULT);
        //
    }; // $._partResults
    ...
    $._uncachedPartResult_ = function(note, argObj_, part, funcNameSuffix) {
        ...
        return this._rules.chainedPartResult_(
...
(function(SATB) {
    ...
    _SATB._NOTE_FUNC = function(func, datum) { // v0.04a+
    ...
    _SATB._NOTE_ARG_OBJS = { // Hotspot
        ...
        coreActState: _SATB._NOTE_FUNC,
        // v0.04a+
        isBarVisible: _SATB._NOTE_FUNC,
        chargeMax: function(func, datum, argObj_, latestChargeMax) {
            return func(datum, datum.meta.satb.datumType, latestChargeMax);
        }, // chargeMax
    ...
    _SATB._NOTE_TYPES = {
        ...
        // v0.04a+
        isBarVisible: _SATB._BOOL_RESULT_NOTES,
...
(function(SATB) {
    ...
    _SATB._RESULT_CHAINING_RULE_FUNC = function(func) { // Potential Hotspot
        ...
        return function(list, note, argObj_, initVal_) { // Potential Hotspot
            ...
            //
            if (SATBM.IS_VALID_RESULT(initVal_)) return list.reduce(f, initVal_);
    ...
    _SATB._NOTE_CHAINING_RULES = {
        ...
        // v0.04a+
        isBarVisible: "_isBarVisibleNoteChainingRule",
...
(function(SATB) {
     ...
     */
    $.onTryancelActorChargeSATB = function(i) {
        var actor_ = this.members()[i];
        if (actor_) actor_.onCancelSATBCharge();
    }; // $.onTryancelActorChargeSATB

    /**
     * Idempotent
     * @interface @since v0.04a @version v0.04a
     * @param {Index} i - The index of the actor to start forcing charging ATB
     */
     ...
     * Idempotent
     * @interface @since v0.04a @version v0.04a
     * @param {Index} i - The index of the actor to end forcing the charging ATB
     */
    ...
    // v0.00a - v0.00a; Extended
        ...
        $gameActors.actor(actorId).clearCoreSATBActs(0);
        //
    }; // _SATB._removeActor
...
(function(SATB) {
    ...
    _SATB._CMDS = Object.keys(GB.NOTE_FORWARDED_FUNCS).concat([
        ...
        "addSATBActTimes",
        "multiplySATBActTimes"
    ]).concat(GB.PHASE_TYPE_FORWARDED_FUNCS);
    //
...
(function(SATB) {
    ...
    // v0.03a - v0.03a; Extended
        // Added to reconstrcut the battler sprite ATB bar upon battler change
    ...
    _SATB._setBattler = function(battler) {
        ...
        if (this._satb && this._satb.bar) {
            return this._satb.bar.setBattler(battler);
        }
        //
        _SATB._initBar.call(this, battler);
    }; // _SATB._setBattler
...
(function(SATB) {
    ...
    _SATB.START_FORCE_CHARGE = "Start", _SATB.END_FORCE_CHARGE = "End";
    ...
    _SATB._procHandling = function() {
        ...
        forceKeys.forEach(_SATB._procForceHotkey, this);
    }; // _SATB._procHandling
     ...
     * @enum @param {KeyMap} hotkey - The mapping of the hotkey to be processed
     */
    _SATB._procForceHotkey = function(hotkey) {
...
(function(SATB) {
    ...
    // {Number} _proportion: The ATB bar fill proportion
     ...
     * Hotspot/Nullipotent
     * @interface @since v0.03a @version v0.03a
     * @returns {Natural Number} The line height of this window
     ...
     * Hotspot/Nullipotent
     * @interface @since v0.03a @version v0.03a
     * @returns {Natural Number} The text size of this window
     * @todo Considers using notetags instead of just parameter function results
     */
    ...
    $._updateOpacities = function() {
        var backOpacity = this.standardBackOpacity();
        if (this.backOpacity !== backOpacity) this.backOpacity = backOpacity;
    ...
    $._update = function() {
        ...
        var isUpdateProportion =
                this._isCacheUpdated("_proportion", this._fillProportion());
     ...
     * Hotspot/Nullipotent
     * @since v0.03a @version v0.03a
     * @returns {Number} The ATB bar fill proportion
     */
    $._fillProportion = function() {
        if (this._battler.isSATBCharge()) {
            var curCharge = this._battler.chargeSATB() * 1.0;
            return curCharge / this._battler.chargeMaxSATB();
        }
        // Using 1.0 is to ensure that integer division won't be used
        return this._battler.coreSATB() * 1.0 / this._battler.coreMaxSATB();
        //
    }; // $._fillProportion
    ...
    $._redraw = function() {
        ...
        var fillW = this.width * this._proportion;
        this.contents.gradientFillRect(
                0, 0, fillW, this.height, this._color1, this._color2);
        //
        var textW = this.textWidth(this._text);
        this.drawText(this._text, this._textX, this._textY, textW, "center");
    }; // $._redraw

})(DoubleX_RMMV.SATB); // Window_SATBBar.prototype
...
(function(SATB) {
    ...
    $._updateText = function() {
        ...
        if (isUpdateWH) {
            this.createContents();
            if (!this._isEnabled) this.changePaintOpacity(false);
        } else {
            this.contents.clear();
     ...
     * Hotspot/Nullipotent
     * @since v0.02a @version v0.03a
     * @returns {Natural Num} The window x position
     */
    $._w = function() {
    ...
    $._redrawText = function() {
        var textW = this.textWidth(this._lastText);
        this.drawText(this._lastText, this._lastTextX, this._lastTextY, textW,
                "center");
    }; // $._redrawText
...
(function(SATB) {
     ...
     */
    $._onTouch = function() {
        if (!this._isEnabled) return SoundManager.playBuzzer();
        SoundManager.playOk();
        this._onForceRun();
        this.refresh();
    }; // $._onTouch
...
})(DoubleX_RMMV.SATB); // Window_SATBForceRunCmd.prototype
...
})(DoubleX_RMMV.SATB); // Window_SATBForceStopCmd.prototype
...
(function(SATB) {
    ...
    $.onForceRun = function() {
        ...
        this._forceState = this.isForceStop() ? "" : _SATB._FORCE_RUN;
    ...
    $.onForceStop = function() {
        var forceState = this._forceState;
        this._forceState = this.isForceRun() ? "" : _SATB._FORCE_STOP;
        if (forceState !== this._forceState) this.refresh();
    }; // $.onForceStop
...
(function(SATB) {
    ...
    // v0.04a - v0.04a; Extended
        ...
        _SATB._createCancelForceChargeHotkeys.call(this);
        //
    }; // $.createStatusWindow
    ...
    /**
     * Hotspot/Nullipotent
     * @interface @since v0.02a @version v0.03a
     * @returns {Boolean} The check result
     */
    ...
    $.refreshSATBInputWins = function() {
        if (!SATBManager.isEnabled()) return;
        this._satb.forceRunCmdWin.refresh();
        this._satb.forceStopCmdWin.refresh();
        this._satb.forceStatusWin.refresh();
    ...
    _SATB._updateBattleProc = function() {
        ...
        if (!BattleManager.canUpdateSATB()) return; // Checking twice's simpler
     ...
     * @since v0.04a @version v0.04a
     */
    _SATB._createCancelForceChargeHotkeys = function() {
        _SATB._createCancelChargeHotkeys.call(this);
        _SATB._createForceChargeHotkeys.call(this);
    }; // _SATB._createCancelForceChargeHotkeys
    ...
    _SATB._createCancelChargeHotkey = function(hotkey, i) {
        this._statusWindow.setHandler(hotkey,
                $gameParty.onTryancelActorChargeSATB.bind($gameParty, i));
    ...
    _SATB._onTrySelectActorIndexByHotkey = function(i) {
        ...
        if (!BattleManager.isUnselectedSATBInputableActor(newActor_)) {
            return SoundManager.playBuzzer();
        }
        //
