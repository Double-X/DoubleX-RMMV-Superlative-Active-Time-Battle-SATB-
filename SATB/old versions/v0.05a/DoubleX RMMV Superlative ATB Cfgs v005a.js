...
DoubleX_RMMV["Superlative ATB Configurations"] = "v0.05a";
//
...
(function(SATB) {
    ...
    SATB.params = {
        ...
        cooldown: {
            ...
            IsCooldownEnabled: function() {
                return false; // Always disable the Cooldown Module
            }, // IsCooldownEnabled
            ...
            canCancelCooldown: function() {
                // Always let players cancel the battler skill/item ATB cooldown
                return true;
                //
            } // canCancelCooldown
    ...
    SATB.notes = {
        ...
        cooldownMax: {
             ...
             * @enum @param {DatumType} datumType - Refers to reference tag
             *                                      NOTE_DATA_TYPES
             * @param {+ve Number} latestCooldownMax - Max cooldown ATB value up
             *                                         to the latest note
             *                                         DON'T USE IT IF THE
             *                                         CHAINING RULE IS AN
             *                                         ASSOCIATIVE OPERATOR
             *                                         Refer to reference tag
             *                                         ASSOCIATIVE_CHAINING_RULE
             * @returns {+ve Number} The maximum cooldown ATB value(Which should
             *                       be positive) for the battler involved
             */
