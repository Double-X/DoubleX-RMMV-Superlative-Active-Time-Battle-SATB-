...
DoubleX_RMMV["Superlative ATB Implementations"] = "v0.08a";
//
...
(function(SATB) {
    ...
    _SATB._DEFAULT_RESULTS = { // Potential Hotspot
        ...
        isStatusBarVisible: function() { // (v0.06a+)Bar Module
            return $gameSystem.satbParamFunc("isShowStatusATBBar").call(
                    this._battler);
        }, // isStatusBarVisible
        // (v0.04a+)Charge Module
        ...
        // (v0.08a+)Speed Module
        actSpeed: function() {
            return $gameSystem.satbParamFunc("actSpeed").call(this._battler);
        } // actSpeed
        //
    ...
    _SATB._NOTE_ARG_OBJS = { // Hotspot
        ...
        //
        // (v0.07a+)Reset Module
        resetATBVal: function(battler, func, datum, argObj_, latestResetATBVal) {
            var datumType = datum.meta.satb.datumType;
            return func.call(battler, datum, datumType, latestResetATBVal);
        }, // resetATBVal
        //
        // (v0.08a+)Speed Module
        actSpeed: function(battler, func, datum, argObj_, latestActSpeed) {
            var datumType = datum.meta.satb.datumType;
            return func.call(battler, datum, datumType, latestActSpeed);
        } // actSpeed
        //
