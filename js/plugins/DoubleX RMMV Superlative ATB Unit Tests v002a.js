...
DoubleX_RMMV["Superlative ATB Unit Tests"] = "v0.02a";
//
    ...
    SATBUT.unitTests = {
        ...
        params: {
            ...
            wait: {
                ...
                forceATBStatTranslucentOpacity: "checkOpacity",
                ...
                forceATBRunCmdTranslucentOpacity: "checkOpacity",
                ...
                forceATBStopCmdTranslucentOpacity: "checkOpacity",
        ...
        testParamArgsWithoutContext: {
            ...
            wait: {
                ...
                forceATBStatTranslucentOpacity: SATBUT.testNoArgParamFunc,
                ...
                forceATBRunCmdTranslucentOpacity: SATBUT.testNoArgParamFunc,
                ...
                forceATBStopCmdTranslucentOpacity: SATBUT.testNoArgParamFunc,
    ...
    _UT._checkChainedValResult = function(list, note, argObj_, initVal_, chainedResult) {
        ...
        if (chainedFunc) list.forEach(function(val, i) {
            SATBUT.checkFuncs[chainedFunc](val,
                    "GSATBR.new._checkChainedResult chainedResult " + i +
                    "th " + note + " value");
        });
        _UT._checkNoteArgObjInitValChainedResult.call(
                this, note, argObj_, initVal_, chainedResult);
