...
DoubleX_RMMV["Superlative ATB Implementations"] = "v0.05a";
//
...
(function(SATB) {
    ...
    DataManager.scanSATBFuncContentForSwitchVars = function(funcContent, noteType) {
        // Refer to reference tag SWITCH_VAR
        Object.keys(_SATB._SWITCH_VAR_REG_EXPS).forEach(
...
(function(SATB) {
    ...
    _SATB._PARAM_UPDATES = {
        ...
        _ooldownMaxATBValNoteChainingRule: SATBManager.updateNoteChainingRule.
                bind(SATBManager, "ooldownMax"),
        _ooldownMaxATBValNotePriorities: SATBManager.updateNotePriorities.bind(
                SATBManager, "ooldownMax"),
...
(function(SATB) {
     ...
     * Hotspot/Nullipotent
     * @interface @since v0.05a @version v0.05a
     * @returns {+ve Number} Base Maximum ATB cooldown value of battler involved
     */
    ...
    $.onBecomeNotSATBActable = function() {
        ...
        // The ATB cooldown needs to use the latest skill/item data
        if (!this.isSATBCooldown()) delete this.latestSATBItem_;
     ...
     * @returns {Boolean} The check result
     */
    $.onEndSATBCooldown = function() {
        this._satb.phaseTypes.onEndCooldown();
...
(function(SATB) {
     ...
     * Script Call/Idempotent
     * @interface @since v0.05a @version v0.05a
     * @returns {+ve Number} The cooldown ATB fill proportion of the battler
     */
    ...
    $.checkUpdatedMaxes = function() {
        ...
        //
        if (!this.isFill()) return this._checkUpdatedMax(
                this.curATB(), this._phase, this._battler.curMaxSATB());
    }; // $.checkUpdatedMaxes
    ...
    $.onEndCharge = function() {
        ...
        if (this.isCharge()) this._phase = _SATB._PHASE_NORM;
        //
    ...
    $.onCancelCooldown = function() {
        ...
        if (this.isCooldown() && this._battler.canCancelCooldownSATB()) {
            this._battler.onEndSATBCooldown();
        }
    }; // $.onCancelCooldown
...
(function(SATB) {
    ...
    _SATB._DEFAULT_RESULTS = { // Potential Hotspot
        ...
        //
        // (v0.05a+)Cooldown Module
        cooldownMax: function() { return this._battler.baseCooldownMaxSATB(); },
    ...
    _SATB._NOTE_ARG_OBJS = { // Hotspot
        ...
        //
        // (v0.05a+)Cooldown Module
        cooldownMax: function(func, datum, argObj_, latestCooldownMax) {
            return func(datum, datum.meta.satb.datumType, latestCooldownMax);
        }, // cooldownMax
...
(function(SATB) {
    ...
    _SATB._ON_ALL_ACTS_END = function(mem) { mem.eraseVirtualSATBActSlot(); };
...
(function() {
    ...
    var $ = Window_Selectable.prototype;
    ...
    $.callHandlers = $.callHandlers || function(symbol) {
        ...
        this._handlers[symbol].forEach(function(method) { method(); });
    }; // $.callHandlers
...
(function(SATB) {
    ...
    _SATB._procHandling = function() {
        ...
        if (SATBManager.areModulesEnabled(["IsChargeEnabled"])) {
            cancelKeys = $gameSystem.satbParamFunc("cancelChargeATBKeys")();
        ...
        cancelCDKeys.filter(function(key) {
            ...
            return !cancelKeys || !cancelKeys.contains(key);
            //
...
(function() {
    ...
    $._fillProportion = function() {
        return this._battler.curSATBProportion();
    }; // $._fillProportion
