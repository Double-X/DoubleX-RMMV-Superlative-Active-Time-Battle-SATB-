...
DoubleX_RMMV["Superlative ATB Unit Tests"] = "v0.04a";
//
...
(function(SATBUT) {
    ...
    SATBUT.unitTests = {
        ...
        noteChainingRules: {
            ...
            // v0.04a+
            isBarVisible: "checkChainBoolRule",
    ...
    SATBUT.checkFuncs = {
         ...
         * @param {String} param - The parameter being tested
         */
        checkColor: function(val, param) {
            if (!SATBUT.checkFuncs.checkString(val, param)) return;
            if (val.length === 7 && val.match(/#[0-9a-f]{6}/)) return;
            SATBUT.showFailMsg(val, param, "It should be a valid Color!");
        }, // checkColor
        ...
        checkData: function(val, param) {
            var meta = val.meta;
            if (!meta || !meta.satb || !meta.satb.datumType) SATBUT.showFailMsg(
        ...
        checkFunc: function(val, param) {
            ...
            return SATBUT.showFailMsg(val, param, "func should be a function!");
        }, // checkFunc
         ...
         * @returns {Boolean} The check result
         */
        checkInt: function(val, param) {
            return Number.isInteger(val) || SATBUT.showFailMsg(
         ...
         * @param {String} param - The parameter being tested
         */
        checkModule: function(val, param) {
            SATBUT.checkFuncs.checkVal(val, param, [
                "IsCoreEnabled",
                "IsBarEnabled",
                "IsHotkeyEnabled",
        ...
        checkOpacity: function(val, param) {
            if (!SATBUT.checkFuncs.checkInt(val, param)) return;
         ...
         * @param {String} param - The parameter being tested
         */
        checkStringArray: function(val, param) {
            if (!SATBUT.checkFuncs.checkArray(val, param)) return;
            val.forEach(function(v, i) {
                SATBUT.checkFuncs.checkString(v, param + " " + i + "th elem");
            });
        }, // checkStringArray
...
(function(SATB, SATBUT) {
    ...
    // v0.04a - v0.04a; Extended
        ...
        // Added to check the argument of this public api
        SATBUT.checkFuncs.checkInt(frame, "_SATBTM.setTurnClockFrame frame");
        //
...
(function(SATB, SATBUT) {
    ...
    // v0.04a - v0.04a; Extended
        ...
        _UT._checkEraseCoreSATBActs.call(this);
     ...
     * @since v0.00a @version v0.00a
     */
    _UT._checkEraseCoreSATBActs = function() {
        if (BattleManager._satb.inputableActors.contains(this)) {
            SATBUT.showFailMsg(this.name(),
                    "GBB.new._checkEraseCoreSATBActs",
                    "A battler right after having its ATB and action slots " +
                    "erased shouldn't be inputable!");
        }
        if (!BattleManager._actionBattlers.contains(this)) return;
        SATBUT.showFailMsg(this.name(),
                "GBB.new._checkEraseCoreSATBActs",
                "A battler right after having its ATB and action slots " +
                "erased shouldn't be able to execute actions!");
    }; // _UT._checkEraseCoreSATBActs
...
(function(SATB, SATBUT) {
    ...
    _GSATBPT.setCoreATBProportion = $.setCoreATBProportion;
    _UT.setCoreATBProportion = $.addChargeATBProportion = function(increment) {
    // v0.04a - v0.04a; Extended
    ...
    _UT._checkDidCoreATBBecomeFull = function() {
        ...
        if (isInputable || isActable || this._battler.isSATBCharge()) return;
        //
        SATBUT.showFailMsg(this._battler.name(),
    ...
    _UT._checkDidCoreATBBecomeNotFull = function() {
        ...
        if (BattleManager._actionBattlers.contains(this._battler)) {
            SATBUT.showFailMsg(this._battler.name(),
                    "GSATBPT.new._checkDidCoreATBBecomeNotFull",
                    "A battler right after not having full ATB value " +
                    "shouldn't be able to execute actions!");
        }
        if (this._battler.isSATBCharge()) {
            SATBUT.showFailMsg(this._battler.name,
                    "GSATBPT.new._checkDidCoreATBBecomeNotFull",
                    "A battler right after not having full ATB value " +
                    "shouldn't be charging a skill/item!");
        }
...
(function(SATB, SATBUT) {
    ...
    _UT.lineHeight = $.lineHeight = function() { // v0.04a - v0.04a; Extended
        ...
        SATBUT.checkFuncs.checkNaturalNum(lineH, "_WSATBB.lineHeight lineH");
        //
        return lineH;
    }; // $.lineHeight
    ...
    // v0.04a - v0.04a; Extended
        ...
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs.checkOpacity(
    ...
    _UT._isVisible = $._isVisible = function() { // v0.04a - v0.04a; Extended
        ...
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs.checkBool(isVisible, "_WSATBB._isVisible isVisible");
        //
        return isVisible;
    }; // $._isVisible
    ...
    _UT._x = $._x = function() { // v0.04a - v0.04a; Extended
        ...
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs.checkInt(x, "_WSATBB._x x");
        //
        return x;
    }; // $._x
    ...
    _UT._y = $._y = function() { // v0.04a - v0.04a; Extended
        ...
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs.checkInt(y, "_WSATBB._y y");
        //
        return y;
    }; // $._y
    ...
    _UT._w = $._w = function() { // v0.04a - v0.04a; Extended
        ...
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs.checkNaturalNum(w, "_WSATBB._w w");
        //
        return w;
    }; // $._w
    ...
    _UT._h = $._h = function() { // v0.04a - v0.04a; Extended
        ...
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs.checkNaturalNum(h, "_WSATBB._h h");
        //
        return h;
    }; // $._h
    ...
    _UT._barColor1 = $._barColor1 = function() { // v0.04a - v0.04a; Extended
        ...
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs.checkColor(barColor1, "_WSATBB._barColor1 barColor1");
        //
        return barColor1;
    }; // $._barColor1
    ...
    _UT._barColor2 = $._barColor2 = function() { // v0.04a - v0.04a; Extended
        ...
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs.checkColor(barColor2, "_WSATBB._barColor2 barColor2");
        //
        return barColor2;
    }; // $._barColor2
    ...
    // v0.04a - v0.04a; Extended
        ...
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs.checkInt(textX, "_WSATBB._textXOffset textX");
        //
        return textX;
    }; // $._textXOffset
    ...
    // v0.04a - v0.04a; Extended
        ...
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs.checkInt(textY, "_WSATBB._textYOffset textY");
        //
        return textY;
    }; // $._textYOffset
    ...
    // v0.04a - v0.04a; Extended
        ...
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs.checkString(text, "_WSATBB._formattedText text");
        //
        return text;
    }; // $._formattedText
    ...
    _UT._checkFillProportion = function(fillProportion) {
        // It's possible for a charging battler to charge beyond maximum
