 ...
 *         (Solid understanding on how RMMV plugin development works in
 *         details with dozens of tolerable quality plugins written without
 *         nontrivial bugs up to 3000 LoC scale and being experienced)
 *      Knowledge:
...
DoubleX_RMMV["Superlative ATB Documentations"] = "v0.05b";
//

// Ensures that all plugins are of the latest version
DoubleX_RMMV.SATB_VERS = {
    Parameters: "v0.05a",
    Configurations: "v0.05b",
    Implementations: "v0.05b",
    "Unit Tests": "v0.05b",
