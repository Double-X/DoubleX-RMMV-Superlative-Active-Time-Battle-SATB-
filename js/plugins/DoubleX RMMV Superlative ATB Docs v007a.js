 ...
 *      10. (v0.07a+)DoubleX RMMV Superlative ATB(Core And Reset Module Only)
 ...
 *         DoubleX RMMV Superlative ATB Params v007a
...
DoubleX_RMMV["Superlative ATB Documentations"] = "v0.07a";
//

// Ensures that all plugins are of the latest version
DoubleX_RMMV.SATB_VERS = {
    Parameters: "v0.07a",
    Configurations: "v0.07a",
    Implementations: "v0.07a",
    "Unit Tests": "v0.07a",
