 ...
 *         DoubleX RMMV Superlative ATB Params v012a
 ...
 *      - v0.12a(GMT 1400 24-Jul-2020):
 *        1. Finished the countdown module
 *        2. Battle turn clock second unit counter's stored in seconds instead
 *           of milliseconds
 *      - v0.11a(GMT 1300 23-Jul-2020):
 *        1. Finished the turn module
 *      - v0.10a(GMT 0900 23-Jul-2020):
...
DoubleX_RMMV["Superlative ATB Documentations"] = "v0.12a";
//

// Ensures that all plugins are of the latest version
DoubleX_RMMV.SATB_VERS = {
    Parameters: "v0.12a",
    Configurations: "v0.12a",
    Implementations: "v0.12a",
    "Unit Tests": "v0.12a",
