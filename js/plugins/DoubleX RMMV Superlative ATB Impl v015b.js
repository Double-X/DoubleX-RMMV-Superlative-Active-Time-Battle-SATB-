...
DoubleX_RMMV["Superlative ATB Implementations"] = "v0.15b";
//
...
(function(SATB) {
    ...
    $.setSATBActTimes = function(actTimes) {
        _SATB._setSATBActTimes.call(this, actTimes);
     ...
     * The this pointer is Game_Battler.prototype
     * Idempotent
     * @since v0.15b @version v0.15b
     * @param {Nonnegative Int} actTimes - The new number of virtual action slot
     */
    _SATB._setSATBActTimes = function(actTimes) {
        var hadActs = this.satbActTimes() > 0, hasActs = actTimes > 0;
