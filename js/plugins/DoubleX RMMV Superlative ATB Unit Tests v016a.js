...
DoubleX_RMMV["Superlative ATB Unit Tests"] = "v0.16a";
//
...
(function(SATB) {
    ...
    SATB.Unit_Tests = {
        ...
        /**
         * Logs the calls of the functions and the contents of those calls
         * Hotspot/No-op
 ...
 *         - Solid understanding on how the implementation plugin works on its
 *           own in details to fully comprehend this unit test plugin
 *----------------------------------------------------------------------------*/
...
(function(SATB, SATBUT) {
    ...
    var _NOTES = Object.keys(SATB.Game_System.new.PARAM_NOTE_FUNCS.notes);
    ...
    SATBUT.unitTests = {
        ...
        params: {
            ...
            bar: { // v0.03a+
                ...
                atbBarFrameOpacity: "checkOpacity", // v0.06a+
                atbBarW: "checkNaturalNum",
                atbBarH: "checkNaturalNum",
                atbBarFontFace: "checkString", // v0.14a+
                atbBarTextSize: "checkNaturalNum",
                atbBarLineH: "checkNaturalNum",
                atbBarPadding: "checkNonnegativeInt", // v0.06a+
                atbBarBackOpacity: "checkOpacity",
                atbBarWinskinPath: "checkString", // v0.14a+
                ...
                // v0.06a+
                isShowStatusATBBar: "checkBool",
                statusATBBarText: "checkString",
                statusATBBarXOffset: "checkInt",
                statusATBBarYOffset: "checkInt",
                statusATBBarFrameOpacity: "checkOpacity", // v0.06a+
                statusATBBarW: "checkNaturalNum",
                statusATBBarH: "checkNaturalNum",
                statusATBBarFontFace: "checkString", // v0.14a+
                statusATBBarTextSize: "checkNaturalNum",
                statusATBBarLineH: "checkNaturalNum",
                statusATBBarPadding: "checkNonnegativeInt", // v0.06a+
                statusATBBarBackOpacity: "checkOpacity",
                statusATBBarWinskinPath: "checkString", // v0.14a+
                ...
                statusATBBarTextColor: "checkColor",
                statusATBBarColor1: "checkColor",
                statusATBBarColor2: "checkColor",
                statusATBBarBackColor: "checkColor",
                _isStatusBarVisibleNoteChainingRule: "checkChainBoolRule",
                _isStatusBarVisibleNotePriorities: "checkArrayDataType"
                //
            }, // bar
            hotkey: { // v0.01a+
            ...
            wait: { // v0.02a+
                ...
                forceATBStatOpacity: "checkOpacity", // v0.14a+
                forceATBStatWinW: "checkNaturalNum",
                forceATBStatWinH: "checkNaturalNum",
                forceATBStatFontFace: "checkString", // v0.14a+
                ...
                forceATBStatWinskinPath: "checkString", // v0.14a+
                forceATBStatWinskinFile: "checkString", // v0.14a+
                forceATBStatWinskinHue: "checkHue", // v0.14a+
                forceATBStatWinskinSmooth: "checkBool", // v0.14a+
                forceATBStatTextColor: "checkColor", // v0.14a+
                forceATBStatTextAlign: "checkTextAlign", // v0.14a+
                ...
                forceATBRunCmdOpacity: "checkOpacity", // v0.14a+
                forceATBRunCmdWinW: "checkNaturalNum",
                forceATBRunCmdWinH: "checkNaturalNum",
                forceATBRunCmdFontFace: "checkString", // v0.14a+
                ...
                forceATBRunCmdWinskinPath: "checkString", // v0.14a+
                forceATBRunCmdWinskinFile: "checkString", // v0.14a+
                forceATBRunCmdWinskinHue: "checkHue", // v0.14a+
                forceATBRunCmdWinskinSmooth: "checkBool", // v0.14a+
                forceATBRunCmdTextColor: "checkColor", // v0.14a+
                forceATBRunCmdTextAlign: "checkTextAlign", // v0.14a+
                ...
                forceATBStopCmdOpacity: "checkOpacity", // v0.14a+
                forceATBStopCmdWinW: "checkNaturalNum",
                forceATBStopCmdWinH: "checkNaturalNum",
                forceATBStopCmdFontFace: "checkString", // v0.14a+
                ...
                forceATBStopCmdWinskinPath: "checkString", // v0.14a+
                forceATBStopCmdWinskinFile: "checkString", // v0.14a+
                forceATBStopCmdWinskinHue: "checkHue", // v0.14a+
                forceATBStopCmdWinskinSmooth: "checkBool", // v0.14a+
                forceATBStopCmdTextColor: "checkColor", // v0.14a+
                forceATBStopCmdTextAlign: "checkTextAlign", // v0.14a+
                forceATBStopCmdTextXOffset: "checkInt",
                forceATBStopCmdTextYOffset: "checkInt"
            }, // wait
            act: { // v0.16a+
                IsActEnabled: "checkBool",
                actMode: "checkActMode",
                _actCostNoteChainingRule: "checkChainNumRule",
                _actCostNotePriorities: "checkArrayDataType",
                _actModeNoteChainingRule: "checkChainMonoRule",
                _actModeNotePriorities: "checkArrayDataType"
            }, // act
            charge: { // v0.04a+
            ...
            countdown: { // v0.12a+
                IsCountdownEnabled: "checkBool",
                _countdownNoteChainingRule: "checkChainMonoTruthyRule"
            }, // countdown
            ctb: { // v0.13a+
                IsCTBEnabled: "checkBool",
                isShowCTBWin: "checkBool",
                ctbWinText: "checkString",
                ctbWinX: "checkNonnegativeNum",
                ctbWinY: "checkNonnegativeNum",
                ctbWinOpacity: "checkOpacity", // v0.14a+
                ctbWinW: "checkNaturalNum",
                ctbWinH: "checkNaturalNum",
                ctbWinFontFace: "checkString", // v0.14a+
                ctbWinTextSize: "checkNaturalNum",
                ctbWinLineH: "checkNaturalNum",
                ctbWinPadding: "checkNonnegativeInt",
                ctbWinBackOpacity: "checkOpacity",
                ctbWinskinPath: "checkString", // v0.14a+
                ctbWinskinFile: "checkString", // v0.14a+
                ctbWinskinHue: "checkHue", // v0.14a+
                ctbWinskinSmooth: "checkBool", // v0.14a+
                ctbWinTextColor: "checkColor", // v0.14a+
                ctbWinTextAlign: "checkTextAlign", // v0.14a+
                ctbWinTextXOffset: "checkInt",
                ctbWinTextYOffset: "checkInt"
            }, // ctb
            delay: { // v0.15a+
                IsDelayEnabled: "checkBool",
                delaySecs: "checkNonnegativeNum",
                _delayNoteChainingRule: "checkChainNumRule",
                _delayNotePriorities: "checkArrayDataType"
            }, // delay
            event: { // v0.06a+
                IsEventEnabled: "checkBool",
                didFinishInput: "checkNothing",
                _didFinishInputNoteChainingRule: "checkChainEventRule",
                _didFinishInputNotePriorities: "checkArrayDataType",
                didBecomeActable: "checkNothing",
                _didBecomeActableNoteChainingRule: "checkChainEventRule",
                _didBecomeActableNotePriorities: "checkArrayDataType",
                didSetActTimes: "checkNothing",
                _didSetActTimesNoteChainingRule: "checkChainEventRule",
                _didSetActTimesNotePriorities: "checkArrayDataType",
                ...
                didStartForceCharge: "checkNothing",
                _didStartForceChargeNoteChainingRule: "checkChainEventRule",
                _didStartForceChargeNotePriorities: "checkArrayDataType",
                willCancelCooldown: "checkNothing",
                _willCancelCooldownNoteChainingRule: "checkChainEventRule",
                _willCancelCooldownNotePriorities: "checkArrayDataType",
                didCoreATBBecomeFull: "checkNothing",
                _didCoreATBBecomeFullNoteChainingRule: "checkChainEventRule",
                _didCoreATBBecomeFullNotePriorities: "checkArrayDataType",
                didCoreATBBecomeNotFull: "checkNothing",
                _didCoreATBBecomeNotFullNoteChainingRule: "checkChainEventRule",
                _didCoreATBBecomeNotFullNotePriorities: "checkArrayDataType",
                didChargeATBBecomeNotFull: "checkNothing",
                _didChargeATBBecomeNotFullNoteChainingRule:
                        "checkChainEventRule",
                _didChargeATBBecomeNotFullNotePriorities: "checkArrayDataType",
                didAddInputableActor: "checkNothing",
                _didAddInputableActorNoteChainingRule: "checkChainEventRule",
                _didAddInputableActorNotePriorities: "checkArrayDataType",
                // v0.12a+
                didDecreaseCountdownStateTurn: "checkNothing",
                _didDecreaseCountdownStateTurnNoteChainingRule:
                        "checkChainEventRule",
                _didDecreaseCountdownStateTurnNotePriorities:
                        "checkArrayDataType",
                didIncreaseCountdownStateTurn: "checkNothing",
                _didIncreaseCountdownStateTurnNoteChainingRule:
                        "checkChainEventRule",
                _didIncreaseCountdownStateTurnNotePriorities:
                        "checkArrayDataType",
                //
                // v0.13a+
                didFillCoreATB: "checkNothing",
                _didFillCoreATBNoteChainingRule: "checkChainEventRule",
                _didFillCoreATBNotePriorities:  "checkArrayDataType",
                didFillChargeATB: "checkNothing",
                _didFillChargeATBNoteChainingRule: "checkChainEventRule",
                _didFillChargeATBNotePriorities: "checkArrayDataType",
                didFillCooldownATB: "checkNothing",
                _didFillCooldownATBNoteChainingRule: "checkChainEventRule",
                _didFillCooldownATBNotePriorities: "checkArrayDataType",
                //
                // v0.15a+
                didDelayCounterEnd: "checkNothing",
                _didDelayCounterEndNoteChainingRule: "checkChainEventRule",
                _didDelayCounterEndNotePriorities: "checkArrayDataType"
                //
            }, // event
            order: { // v0.14a+
                IsOrderEnabled: "checkBool",
                isShowContinuousOrderWin: "checkBool",
                continuousOrderWinX: "checkNonnegativeInt",
                continuousOrderWinY: "checkNonnegativeInt",
                continuousOrderOpacity: "checkOpacity",
                continuousOrderWinW: "checkNaturalNum",
                continuousOrderWinH: "checkNaturalNum",
                continuousOrderFontFace: "checkString",
                continuousOrderTextSize: "checkNaturalNum",
                continuousOrderLineH: "checkNaturalNum",
                continuousOrderPadding: "checkNonnegativeInt",
                continuousOrderBackOpacity: "checkOpacity",
                continuousOrderWinskinPath: "checkString",
                continuousOrderWinskinFile: "checkString",
                continuousOrderWinskinHue: "checkHue",
                continuousOrderWinskinSmooth: "checkBool",
                continuousOrderCooldownBarX: "checkNonnegativeInt",
                continuousOrderCooldownBarY: "checkNonnegativeInt",
                continuousOrderCooldownBarW: "checkNaturalNum",
                continuousOrderCooldownBarH: "checkNaturalNum",
                continuousOrderCooldownBarColor1: "checkColor",
                continuousOrderCooldownBarColor2: "checkColor",
                continuousOrderCooldownTextColor: "checkColor",
                continuousOrderCooldownText: "checkString",
                continuousOrderCooldownTextX: "checkNonnegativeInt",
                continuousOrderCooldownTextY: "checkNonnegativeInt",
                continuousOrderCooldownTextAlign: "checkTextAlign",
                continuousOrderCoreBarX: "checkNonnegativeInt",
                continuousOrderCoreBarY: "checkNonnegativeInt",
                continuousOrderCoreBarW: "checkNaturalNum",
                continuousOrderCoreBarH: "checkNaturalNum",
                continuousOrderCoreBarColor1: "checkColor",
                continuousOrderCoreBarColor2: "checkColor",
                continuousOrderCoreTextColor: "checkColor",
                continuousOrderCoreText: "checkString",
                continuousOrderCoreTextX: "checkNonnegativeInt",
                continuousOrderCoreTextY: "checkNonnegativeInt",
                continuousOrderCoreTextAlign: "checkTextAlign",
                continuousOrderChargeBarX: "checkNonnegativeInt",
                continuousOrderChargeBarY: "checkNonnegativeInt",
                continuousOrderChargeBarW: "checkNaturalNum",
                continuousOrderChargeBarH: "checkNaturalNum",
                continuousOrderChargeBarColor1: "checkColor",
                continuousOrderChargeBarColor2: "checkColor",
                continuousOrderChargeTextColor: "checkColor",
                continuousOrderChargeText: "checkString",
                continuousOrderChargeTextX: "checkNonnegativeInt",
                continuousOrderChargeTextY: "checkNonnegativeInt",
                continuousOrderChargeTextAlign: "checkTextAlign",
                continuousOrderSpriteOpacity: "checkOpacity",
                continuousOrderSpriteIconFolder: "checkString",
                continuousOrderSpriteIconFilename: "checkString",
                continuousOrderSpriteIconHue: "checkHue",
                continuousOrderSpriteIconSmooth: "checkBool",
                continuousOrderSpriteIconXCoor: "checkNonnegativeInt",
                continuousOrderSpriteIconYCoor: "checkNonnegativeInt",
                continuousOrderSpriteIconSourceW: "checkNaturalNum",
                continuousOrderSpriteIconSourceH: "checkNaturalNum",
                ...
                discreteOrderSpriteX: "checkNonnegativeNum",
                discreteOrderSpriteY: "checkNonnegativeNum",
            ...
            rate: { // v0.10a+
                ...
                _coreATBRateNoteChainingRule: "checkChainNumRule",
                _coreATBRateNotePriorities: "checkArrayDataType",
                chargeATBRate: "checkNum",
                _chargeATBRateNoteChainingRule: "checkChainNumRule",
                _chargeATBRateNotePriorities: "checkArrayDataType",
                cooldownATBRate: "checkNum",
                _cooldownATBRateNoteChainingRule: "checkChainNumRule",
                _cooldownATBRateNotePriorities: "checkArrayDataType"
            }, // rate
            reset: { // v0.07a+
                IsResetEnabled: "checkBool",
                resetATBVal: "checkNum",
                _resetATBValNoteChainingRule: "checkChainNumRule",
                _resetATBValNotePriorities: "checkArrayDataType"
            }, // reset
            speed: { // v0.08a+
                IsSpeedEnabled: "checkBool",
                updateActSpeeds: "checkNothing",
                actSpeed: "checkNum",
                _actSpeedNoteChainingRule: "checkChainNumRule",
                _actSpeedNotePriorities: "checkArrayDataType"
            }, // speed
            start: { // v0.09a+
                IsStartEnabled: "checkBool",
                normStartATBVal: "checkNum",
                _normStartATBValNoteChainingRule: "checkChainNumRule",
                _normStartATBValNotePriorities: "checkArrayDataType",
                preemptStartATBVal: "checkNum",
                _preemptStartATBValNoteChainingRule: "checkChainNumRule",
                _preemptStartATBValNotePriorities: "checkArrayDataType",
                surpriseStartATBVal: "checkNum",
                _surpriseStartATBValNoteChainingRule: "checkChainNumRule",
                _surpriseStartATBValNotePriorities: "checkArrayDataType"
            }, // start
            turn: { // v0.11a+
                IsTurnEnabled: "checkBool",
                isShowBattleTurnClockWin: "checkBool",
                battleTurnClockText: "checkString",
                battleTurnClockWinX: "checkNonnegativeNum",
                battleTurnClockWinY: "checkNonnegativeNum",
                battleTurnClockOpacity: "checkOpacity", // v0.14a+
                battleTurnClockWinW: "checkNaturalNum",
                battleTurnClockWinH: "checkNaturalNum",
                battleTurnClockFontFace: "checkString", // v0.14a+
                battleTurnClockTextSize: "checkNaturalNum",
                battleTurnClockWinLineH: "checkNaturalNum",
                battleTurnClockWinPadding: "checkNonnegativeInt",
                battleTurnClockBackOpacity: "checkOpacity",
                battleTurnClockWinskinPath: "checkString", // v0.14a+
                battleTurnClockWinskinFile: "checkString", // v0.14a+
                battleTurnClockWinskinHue: "checkHue", // v0.14a+
                battleTurnClockWinskinSmooth: "checkBool", // v0.14a+
        ...
        testParamArgsWithoutContext: {
            ...
            bar: { /* v0.03a+ */ IsBarEnabled: SATBUT.testNoArgParamFunc },
            hotkey: { // v0.01a+
            ...
            act: { // v0.16a+
                IsActEnabled: SATBUT.testNoArgParamFunc,
                actMode: SATBUT.testNoArgParamFunc
            }, // wait,
            charge: { // v0.04a+
            ...
            countdown: { // v0.12a+
                IsCountdownEnabled: SATBUT.testNoArgParamFunc,
            }, // countdown
            ctb: { /* v0.13a+ */ IsCTBEnabled: SATBUT.testNoArgParamFunc },
            delay: { /* v0.15a+ */ IsDelayEnabled: SATBUT.testNoArgParamFunc },
            order: { /* v0.14a+ */ IsOrderEnabled: SATBUT.testNoArgParamFunc },
            event: { /* v0.06a+ */ IsEventEnabled: SATBUT.testNoArgParamFunc },
            rate: { /* v0.10a+ */ IsRateEnabled: SATBUT.testNoArgParamFunc },
            reset: { /* v0.07a+ */  IsResetEnabled: SATBUT.testNoArgParamFunc },
            speed: { /* v0.08a+ */ IsSpeedEnabled: SATBUT.testNoArgParamFunc },
            start: { /* v0.09a+ */ IsSpeedEnabled: SATBUT.testNoArgParamFunc },
            turn: { /* v0.11a+ */ IsTurnEnabled: SATBUT.testNoArgParamFunc }
        }, // testParamArgsWithoutContext
        ...
        noteTypes: {
            ...
            isStatusBarVisible: "checkBool", // (v0.06a+)Bar Module
            // (v0.16a+)Action Module
            actCost: "checkPositiveNum",
            actMode: "checkActMode",
            //
            ...
            countdown: "checkCountdownUnitInterval",
            //
            delay: "checkNonnegativeNum", // (v0.15a+)Delay Module
            // (v0.14a+)Order Module
            continuousOrderSpriteOpacity: "checkOpacity",
            continuousOrderSpriteIconFolder: "checkString",
            continuousOrderSpriteIconFilename: "checkString",
            ...
            cooldownATBRate: "checkNum",
            //
            resetATBVal: "checkNum", // (v0.07a+)Reset Module
            actSpeed: "checkNum", // (v0.08a+)Speed Module
            // (v0.09a+)Start Module
            normStartATBVal: "checkNum",
            preemptStartATBVal: "checkNum",
            surpriseStartATBVal: "checkNum"
        ...
        noteChainingRules: {
            ...
            isStatusBarVisible: "checkChainBoolRule", // (v0.06a+)Bar Module
            // (v0.16a+)Action Module
            actCost: "checkChainNumRule",
            actMode: "checkChainMonoRule",
            //
            // (v0.04a+)Charge Module
            ...
            //
            // (v0.12a+)Countdown Module
            countdown: "checkChainMonoTruthyRule",
            //
            delay: "checkChainNumRule", // (v0.15a+)Delay Module
            // (v0.06a+)Event Module
            didFinishInput: "checkChainEventRule",
            ...
            didCoreATBBecomeFull: "checkChainEventRule",
            didCoreATBBecomeNotFull: "checkChainEventRule",
            didChargeATBBecomeNotFull: "checkChainEventRule",
            didAddInputableActor: "checkChainEventRule",
            didDecreaseCountdownStateTurn: "checkChainEventRule", // v0.12a+
            didIncreaseCountdownStateTurn: "checkChainEventRule", // v0.12a+
            didFillCoreATB: "checkChainEventRule", // v0.13a+
            didFillChargeATB: "checkChainEventRule", // v0.13a+
            didFillCooldownATB: "checkChainEventRule", // v0.13a+
            didDelayCounterEnd: "checkChainEventRule", // v0.15a+
            //
            // (v0.14a+)Order Module
            continuousOrderSpriteOpacity: "checkChainDefaultRule",
            continuousOrderSpriteIconFolder: "checkChainDefaultRule",
            continuousOrderSpriteIconFilename: "checkChainDefaultRule",
            continuousOrderSpriteIconHue: "checkChainDefaultRule",
            continuousOrderSpriteIconSmooth: "checkChainDefaultRule",
            continuousOrderSpriteIconXCoor: "checkChainDefaultRule",
            continuousOrderSpriteIconYCoor: "checkChainDefaultRule",
            continuousOrderSpriteIconSourceW: "checkChainDefaultRule",
            continuousOrderSpriteIconSourceH: "checkChainDefaultRule",
            ...
            chargeATBRate: "checkChainNumRule",
            cooldownATBRate: "checkChainNumRule",
            //
            resetATBVal: "checkChainNumRule", // (v0.07a+)Reset Module
            actSpeed: "checkChainNumRule", // (v0.08a+)Speed Module
            // (v0.09a+)Start Module
            normStartATBVal: "checkChainNumRule",
            preemptStartATBVal: "checkChainNumRule",
            surpriseStartATBVal: "checkChainNumRule"
            //
        },
        //
        ...
        noteArgObjs: {
            ...
            coreActState: { state: "checkStateDataMeta" }, // Core Module
            didDecreaseCountdownStateTurn: { // Event Module
                stateId: "checkNonnegativeInt"
            }, // didDecreaseCountdownStateTurn
            didIncreaseCountdownStateTurn: { // Event Module
                stateId: "checkNonnegativeInt"
            }, // didIncreaseCountdownStateTurn
            continuousOrderSpriteOpacity: { // Order Module
                sprite: "checkContinuousOrderSprite"
            }, // continuousOrderSpriteOpacity
            continuousOrderSpriteIconFolder: { // Order Module
                sprite: "checkContinuousOrderSprite"
            }, // continuousOrderSpriteIconFolder
            continuousOrderSpriteIconFilename: { // Order Module
                sprite: "checkContinuousOrderSprite"
            }, // continuousOrderSpriteIconFilename
            continuousOrderSpriteIconHue: { // Order Module
                sprite: "checkContinuousOrderSprite"
            }, // continuousOrderSpriteIconHue
            continuousOrderSpriteIconSmooth: { // Order Module
                sprite: "checkContinuousOrderSprite"
            }, // continuousOrderSpriteIconSmooth
            continuousOrderSpriteIconXCoor: { // Order Module
                sprite: "checkContinuousOrderSprite"
            }, // continuousOrderSpriteIconXCoor
            continuousOrderSpriteIconYCoor: { // Order Module
                sprite: "checkContinuousOrderSprite"
            }, // continuousOrderSpriteIconYCoor
            continuousOrderSpriteIconSourceW: { // Order Module
                sprite: "checkContinuousOrderSprite"
            }, // continuousOrderSpriteIconSourceW
            continuousOrderSpriteIconSourceH: { // Order Module
                sprite: "checkContinuousOrderSprite"
            }, // continuousOrderSpriteIconSourceH
            continuousOrderSpriteIconW: { // Order Module
                sprite: "checkContinuousOrderSprite"
            }, // continuousOrderSpriteIconW
            continuousOrderSpriteIconH: { // Order Module
                sprite: "checkContinuousOrderSprite"
    ...
    SATBUT.CHAIN_BOOL_RULES = ["first", "every", "some", "last"];
    SATBUT.CHAIN_EVENT_RULES = ["first", "every", "last"];
    SATBUT.CHAIN_MONO_RULES = ["first", "last"]; // v0.16a+
    SATBUT.CHAIN_MONO_TRUTHY_RULES = ["firstTruthy", "lastTruthy"];
    SATBUT.CHAIN_NUM_RULES = ["first", "+", "-", "*", "/", "%", "=", "last"];
    SATBUT.DATA_TYPES = [
        "thisState",
        "states",
        "skills",
    ...
    SATBUT.checkFuncs = {
         ...
         * @returns {Boolean} The check result
         */
        checkActMode: function(val, param, context_) {
        ...
        checkArrayDataType: function(val, param, context_) {
            SATBUT.checkFuncs.checkArrayVals(
                    val, param, SATBUT.DATA_TYPES, context_);
        }, // checkArrayDataType
        ...
        checkArrayFactor: function(val, param, context_) {
            SATBUT.checkFuncs.checkArrayVals(
                    val, param, SATBUT.FACTORS, context_);
        }, // checkArrayFactor
        ...
        checkChainBoolRule: function(val, param, context_) {
            SATBUT.checkFuncs.checkVal(
                    val, param, SATBUT.CHAIN_BOOL_RULES, context_);
        }, // checkChainBoolRule
         ...
         * @param {{*}?} context_ - The context of the failed test
         */
        checkChainDefaultRule: function(val, param, context_) {
            SATBUT.checkFuncs.checkVal(val, param, ["first"], context_);
        }, // checkChainDefaultRule
         ...
         * @param {{*}?} context_ - The context of the failed test
         */
        checkChainEventRule: function(val, param, context_) {
            SATBUT.checkFuncs.checkVal(
                    val, param, SATBUT.CHAIN_EVENT_RULES, context_);
        }, // checkChainEventRule
         ...
         * @param {{*}?} context_ - The context of the failed test
         */
        checkChainMonoRule: function(val, param, context_) {
            SATBUT.checkFuncs.checkVal(
                    val, param, SATBUT.CHAIN_MONO_RULES, context_);
        }, // checkChainMonoRule
         ...
         * @param {{*}?} context_ - The context of the failed test
         */
        checkChainMonoTruthyRule: function(val, param, context_) {
            SATBUT.checkFuncs.checkVal(
                    val, param, SATBUT.CHAIN_MONO_TRUTHY_RULES, context_);
        }, // checkChainMonoTruthyRule
        ...
        checkChainNumRule: function(val, param, context_) {
            SATBUT.checkFuncs.checkVal(
                    val, param, SATBUT.CHAIN_NUM_RULES, context_);
        }, // checkChainNumRule
         ...
         * @param {{*}?} context_ - The context of the failed test
         */
        checkCountdownUnitInterval: function(val, param, context_) {
            if (!val) return;
            SATBUT.checkFuncs.checkVal(val.unit, param, [
                "frame",
                "sec"
            ], context_);
            SATBUT.checkFuncs.checkNum(val.interval, param, context_);
        }, // checkCountdownUnitInterval
        ...
        checkFactor: function(val, param, context_) {
            SATBUT.checkFuncs.checkVal(val, param, SATBUT.FACTORS, context_);
        }, // checkFactor
         ...
         * @param {{*}?} context_ - The context of the failed test
         */
        checkHue: function(val, param, context_) {
            SATBUT.checkFuncs.checkIntRange(val, param, 0, 360, context_);
        }, // checkHue
        ...
        /**
         * Hotspot/No-op
         * @since v0.04a @version v0.09a
         * @param {*} val - The actual parameter value
         * @param {String} param - The parameter being tested
         * @param {{*}?} context_ - The context of the failed test
         */
        checkModule: function(val, param, context_) {
            SATBUT.checkFuncs.checkVal(val, param, SATBUT.MODULES, context_);
        }, // checkModule
        ...
        checkNoteType: function(val, param, context_) {
            SATBUT.checkFuncs.checkVal(val, param, _NOTES, context_);
        }, // checkNoteType
         ...
         * @since v0.00a @version v0.05a
         */
        checkNothing: function() {}, // It's to prevent forgetting to add params
        ...
        checkOpacity: function(val, param, context_) {
            SATBUT.checkFuncs.checkIntRange(val, param, 0, 255, context_);
        }, // checkOpacity
        ...
        checkPairFunc: function(val, param, context_) {
            ...
            var count = 1;
            do {
                var suffix = val["suffix" + count];
                if (!suffix) {
                    return SATBUT.showFailMsg(JSON.stringify(val), param,
                            "A valid PairFunc should've at least 1 suffixes!");
                }
                SATBUT.checkFuncs.checkBool(
                        suffix.canBind, param + " canBind " + count, context_);
                SATBUT.checkFuncs.checkFunc(suffix.unboundFunc,
                        param + " unboundFunc " + count, context_);
                count++;
            } while (val["suffix" + count]);
        }, // checkPairFunc
         ...
         * @param {{*}?} context_ - The context of the failed test
         */
        checkTextAlign: function(val, param, context_) {
            SATBUT.checkFuncs.checkVal(
                    val, param, SATBUT.TEXT_ALIGNS, context_);
        }, // checkTextAlign
...
(function(SATB, SATBUT) {
    ...
    function testReadNotes() {
        ...
        var satb = { datumType: "states" }, lines = [
            ...
            //
            "<satb countdown val cfg val: true, CUX, -0.5>",
            "</satb coreActState>",
            "<satb coreActState>",
        ...
        if (coreActsState) {
            SATBUT.showFailMsg(satbLines, "SATB.DataManager.new._readNote",
                    "It shouldn't be able to read coreActsState notetags " +
                    "as it's invalid!");
        }
        ...
        var countdown = satb.countdown;
        if (!countdown) {
            SATBUT.showFailMsg(satbLines, "SATB.DataManager.new._readNote",
                    "It should be able to read countdown notetags!");
        } else {
            var firstCountdown = countdown[0];
            if (firstCountdown.suffix1 !== "val") {
                SATBUT.showFailMsg(satbLines, "SATB.DataManager.new._readNote",
                        "The 1st suffix of the 1st countdown notetag should " +
                        "be val!");
            }
            if (firstCountdown.entry1 !== "true") {
                SATBUT.showFailMsg(satbLines, "SATB.DataManager.new._readNote",
                        "The 1st entry of the 1st countdown notetag should " +
                        "be 'true'!");
            }
            if (firstCountdown.suffix2 !== "cfg") {
                SATBUT.showFailMsg(satbLines, "SATB.DataManager.new._readNote",
                        "The 2nd suffix of the 1st countdown notetag should " +
                        "be cfg!");
            }
            if (firstCountdown.entry2 !== "CUX") {
                SATBUT.showFailMsg(satbLines, "SATB.DataManager.new._readNote",
                        "The 2nd entry of the 1st countdown notetag should " +
                        "be CUX!");
            }
            if (firstCountdown.suffix3 !== "val") {
                SATBUT.showFailMsg(satbLines, "SATB.DataManager.new._readNote",
                        "The 3rd suffix of the 1st countdown notetag should " +
                        "be val!");
            }
            if (firstCountdown.entry3 !== "-0.5") {
                SATBUT.showFailMsg(satbLines, "SATB.DataManager.new._readNote",
                        "The 3rd entry of the 1st countdown notetag should " +
                        "be -0.5!");
            }
            if (countdown[1]) {
                SATBUT.showFailMsg(satbLines, "SATB.DataManager.new._readNote",
                        "There shouldn't be more than 1 countdown notetags!");
            }
        }
    } // testReadNotes
...
(function(SATBUT) {
    ...
    _SATBTM.setCoreTurnClockSec = SATBTurnManager.setCoreTurnClockSec;
    SATBTurnManager.setCoreTurnClockSec = function(sec) {
    // v0.04a - v0.04a; Extended
        // Added to log this key timing with its important contexts
        SATBUT.log("pre SATBTurnManager.setCoreTurnClockSec", { sec: sec });
        //
        _SATBTM.setCoreTurnClockSec.apply(this, arguments);
        // Added to check the argument of this public api
        SATBUT.checkFuncs.checkNum(sec, "_SATBTM.setCoreTurnClockSec sec");
        //
    }; // SATBTurnManager.setCoreTurnClockSec
    _UT.setCoreTurnClockSec = SATBTurnManager.setCoreTurnClockSec;
    ...
    _UT.addCoreTurnClockSec = SATBTurnManager.addCoreTurnClockSec;

    _SATBTM.setCurTurnClockSpeed = SATBTurnManager.setCurTurnClockSpeed;
    SATBTurnManager.setCurTurnClockSpeed = function(multiplier) {
    // v0.11a - v0.11a; Extended
        _SATBTM.setCurTurnClockSpeed.apply(this, arguments);
        // Added to check the argument of this public api
        SATBUT.checkFuncs.checkInt(
                multiplier, "_SATBTM.setCurTurnClockSpeed multiplier");
        //
    }; // SATBTurnManager.setCurTurnClockSpeed
        _UT.setCurTurnClockSpeed = SATBTurnManager.setCurTurnClockSpeed;

    _SATBTM.setCoreTurnClockActSpeed = SATBTurnManager.setCoreTurnClockActSpeed;
    SATBTurnManager.setCoreTurnClockActSpeed = function(multiplier) {
    // v0.11a - v0.11a; Extended
        _SATBTM.setCoreTurnClockActSpeed.apply(this, arguments);
        // Added to check the argument of this public api
        SATBUT.checkFuncs.checkInt(
                multiplier, "_SATBTM.setCoreTurnClockActSpeed multiplier");
        //
    }; // SATBTurnManager.setCoreTurnClockActSpeed
    _UT.setCoreTurnClockActSpeed = SATBTurnManager.setCoreTurnClockActSpeed;

    _SATBTM.setCoreTurnClockFrameSpeed =
            SATBTurnManager.setCoreTurnClockFrameSpeed;
    SATBTurnManager.setCoreTurnClockFrameSpeed = function(multiplier) {
    // v0.11a - v0.11a; Extended
        _SATBTM.setCoreTurnClockFrameSpeed.apply(this, arguments);
        // Added to check the argument of this public api
        SATBUT.checkFuncs.checkInt(
                multiplier, "_SATBTM.setCoreTurnClockFrameSpeed multiplier");
        //
    }; // SATBTurnManager.setCoreTurnClockFrameSpeed
    _UT.setCoreTurnClockFrameSpeed = SATBTurnManager.setCoreTurnClockFrameSpeed;

    _SATBTM.setCoreTurnClockSecSpeed = SATBTurnManager.setCoreTurnClockSecSpeed;
    SATBTurnManager.setCoreTurnClockSecSpeed = function(multiplier) {
    // v0.11a - v0.11a; Extended
        _SATBTM.setCoreTurnClockSecSpeed.apply(this, arguments);
        // Added to check the argument of this public api
        SATBUT.checkFuncs.checkNum(
                multiplier, "_SATBTM.setCoreTurnClockSecSpeed multiplier");
        //
    }; // SATBTurnManager.setCoreTurnClockSecSpeed
    _UT.setCoreTurnClockSecSpeed = SATBTurnManager.setCoreTurnClockSecSpeed;
...
(function(SATBUT) {
    ...
    function testPairFuncs() {
            ...
            meta: {
                satb: {
                    ...
                    countdown: [
                        {
                            suffix1: "eval",
                            entry1: "return datum.id !== 4;",
                            suffix2: "val",
                            entry2: "sec",
                            suffix3: "eval",
                            entry3: "return datum.id === 4 ? -1 : 1;"
                        }
                    ],
        ...
        var countdownDatum = JSON.stringify({
            datum: datum,
            note: "countdown"
        });
        ...
        if (!coreMaxPairFunc0) {
            ...
            var suffix1 = coreMaxPairFunc0.suffix1;
            if (!suffix1) {
                SATBUT.showFailMsg(coreMaxPairFunc0,
                        "Game_SATBPairs.prototype.pairFuncs " + coreMaxDatum,
                        "The 1st coreMax PairFunc should have the suffix1 " +
                        "field!");
            } else {
                if (suffix1.canBind) SATBUT.showFailMsg(coreMaxPairFunc0,
                        "Game_SATBPairs.prototype.pairFuncs " + coreMaxDatum,
                        "The canBind field of the 1st coreMax PairFunc " +
                        "should be false!");
                var unboundFunc = suffix1.unboundFunc;
                if (SATBUT.checkFuncs.checkFunc(unboundFunc,
                        "Game_SATBPairs.prototype.pairFuncs 1st unboundFunc",
                        {})) {
                    var result = unboundFunc(
                          datum, datum.meta.satb.datumType, 4);
                    if (result !== 1) SATBUT.showFailMsg(result,
                            "Game_SATBPairs.prototype.pairFuncs " +
                            coreMaxDatum,
                            "The result of the 1st coreMax PairFunc should " +
                            "be 1!");
                }
            }
        }
        if (!coreMaxPairFunc1) {
            ...
            var suffix1 = coreMaxPairFunc1.suffix1;
            if (!suffix1) {
                SATBUT.showFailMsg(coreMaxPairFunc1,
                        "Game_SATBPairs.prototype.pairFuncs " + coreMaxDatum,
                        "The 2nd coreMax PairFunc should have the suffix1 " +
                        "field!");
            } else {
                if (!suffix1.canBind) SATBUT.showFailMsg(coreMaxPairFunc1,
                        "Game_SATBPairs.prototype.pairFuncs " + coreMaxDatum,
                ...
                if (SATBUT.checkFuncs.checkFunc(unboundFunc,
                    ...
                    if (result !== 2) SATBUT.showFailMsg(result,
                            "Game_SATBPairs.prototype.pairFuncs " +
                            coreMaxDatum,
                            "The result of the 2nd coreMax PairFunc should " +
                            "be 2!");
                }
            }
        }
        ...
        if (!coreActStatePairFunc0) {
            ...
            if (coreActStatePairFunc0.datum !== datum) {
                SATBUT.showFailMsg(coreActStatePairFunc0,
                        "Game_SATBPairs.prototype.pairFuncs " +
                        coreActStateDatum,
                        "The datum field of the 1st coreActState PairFunc " +
                        "should be the original datum having the " +
                        "coreActState notetag!");
            }
            var suffix1 = coreActStatePairFunc0.suffix1;
            if (!suffix1) {
                SATBUT.showFailMsg(coreActStatePairFunc0,
                        "Game_SATBPairs.prototype.pairFuncs " +
                        coreActStateDatum,
                        "The 1st coreActState PairFunc should have the " +
                        "suffix1 field!");
            } else {
                if (suffix1.canBind) SATBUT.showFailMsg(coreActStatePairFunc0,
                        "Game_SATBPairs.prototype.pairFuncs " +
                        coreActStateDatum,
                        "The canBind field of the 1st coreActState PairFunc " +
                        "should be false!");
                var unboundFunc = suffix1.unboundFunc;
                if (SATBUT.checkFuncs.checkFunc(unboundFunc,
                        "Game_SATBPairs.prototype.pairFuncs 1st unboundFunc",
                    ...
                    if (result !== true) SATBUT.showFailMsg(result,
                            "Game_SATBPairs.prototype.pairFuncs " +
                            coreActStateDatum,
                            "The result of the 1st coreActState PairFunc " +
                            "should be true!");
                }
            }
        }
        if (!coreActStatePairFunc1) {
            ...
            if (coreActStatePairFunc1.datum !== datum) {
                SATBUT.showFailMsg(coreActStatePairFunc1,
                        "Game_SATBPairs.prototype.pairFuncs " +
                        coreActStateDatum,
                        "The datum field of the 2nd coreActState PairFunc " +
                        "should be the original datum having the " +
                        "coreActState notetag!");
            }
            var suffix1 = coreActStatePairFunc1.suffix1;
            if (!suffix1) {
                SATBUT.showFailMsg(coreActStatePairFunc1,
                        "Game_SATBPairs.prototype.pairFuncs " +
                        coreActStateDatum,
                        "The 2nd coreActState PairFunc should have the " +
                        "suffix1 field!");
            } else {
                if (!suffix1.canBind) SATBUT.showFailMsg(coreActStatePairFunc1,
                        "Game_SATBPairs.prototype.pairFuncs " +
                        coreActStateDatum,
                        "The canBind field of the 2nd coreActState PairFunc " +
                        "should be true!");
                var unboundFunc = suffix1.unboundFunc;
                if (SATBUT.checkFuncs.checkFunc(unboundFunc,
                        "Game_SATBPairs.prototype.pairFuncs 2nd unboundFunc",
                    ...
                    if (result !== false) SATBUT.showFailMsg(result,
                            "Game_SATBPairs.prototype.pairFuncs " +
                            coreActStateDatum,
                            "The result of the 2nd coreActState PairFunc " +
                            "should be false!");
                }
            }
        }
        ...
        var countdownPairFuncs = pairs.pairFuncs("countdown", datum);
        var countdownPairFunc0 = countdownPairFuncs[0];
        if (!countdownPairFunc0) {
            SATBUT.showFailMsg(countdownDatum,
                    "Game_SATBPairs.prototype.pairFuncs",
                    "The countdown PairFunc list should have 1 PairFunc!");
        } else {
            if (countdownPairFunc0.datum !== datum) {
                SATBUT.showFailMsg(coreActStatePairFunc1,
                        "Game_SATBPairs.prototype.pairFuncs " +
                        countdownDatum,
                        "The datum field of the 1st countdown PairFunc " +
                        "should be the original datum having the countdown " +
                        "notetag!");
            }
            var suffix1 = countdownPairFunc0.suffix1;
            if (!suffix1) {
                SATBUT.showFailMsg(countdownPairFunc0,
                        "Game_SATBPairs.prototype.pairFuncs " +
                        countdownDatum,
                        "The 1st countdown PairFunc should have the suffix1 " +
                        "field!");
            } else {
                if (!suffix1.canBind) SATBUT.showFailMsg(countdownPairFunc0,
                        "Game_SATBPairs.prototype.pairFuncs " +
                        countdownDatum,
                        "The condSuffix canBind field of the 1st countdown " +
                        "PairFunc should be true!");
                var unboundFunc = suffix1.unboundFunc;
                if (SATBUT.checkFuncs.checkFunc(unboundFunc,
                        "Game_SATBPairs.prototype.pairFuncs 1st unboundFunc",
                        {})) {
                    var result = unboundFunc(
                            datum, datum.meta.satb.datumType);
                    if (result !== false) SATBUT.showFailMsg(result,
                            "Game_SATBPairs.prototype.pairFuncs " +
                            countdownDatum,
                            "The condEntry result of the 1st countdown " +
                            "PairFunc should be false!");
                }
            }
            var suffix2 = countdownPairFunc0.suffix2;
            if (!suffix2) {
                SATBUT.showFailMsg(countdownPairFunc0,
                        "Game_SATBPairs.prototype.pairFuncs " +
                        countdownDatum,
                        "The 1st countdown PairFunc should have the suffix2 " +
                        "field!");
            } else {
                if (suffix2.canBind) SATBUT.showFailMsg(countdownPairFunc0,
                        "Game_SATBPairs.prototype.pairFuncs " +
                        countdownDatum,
                        "The unitSuffix canBind field of the 1st countdown " +
                        "PairFunc should be false!");
                var unboundFunc = suffix2.unboundFunc;
                if (SATBUT.checkFuncs.checkFunc(unboundFunc,
                        "Game_SATBPairs.prototype.pairFuncs 1st unboundFunc",
                        {})) {
                    var result = unboundFunc(
                            datum, datum.meta.satb.datumType);
                    if (result !== "sec") SATBUT.showFailMsg(result,
                            "Game_SATBPairs.prototype.pairFuncs " +
                            countdownDatum,
                            "The unitEntry result of the 1st countdown " +
                            "PairFunc should be 'sec'!");
                }
            }
            var suffix3 = countdownPairFunc0.suffix3;
            if (!suffix3) {
                SATBUT.showFailMsg(countdownPairFunc0,
                        "Game_SATBPairs.prototype.pairFuncs " +
                        countdownDatum,
                        "The 1st countdown PairFunc should have the suffix3 " +
                        "field!");
            } else {
                if (!suffix3.canBind) SATBUT.showFailMsg(countdownPairFunc0,
                        "Game_SATBPairs.prototype.pairFuncs " +
                        countdownDatum,
                        "The intervalSuffix canBind field of the 1st " +
                        "countdown PairFunc should be true!");
                var unboundFunc = suffix3.unboundFunc;
                if (SATBUT.checkFuncs.checkFunc(unboundFunc,
                        "Game_SATBPairs.prototype.pairFuncs 1st unboundFunc",
                        {})) {
                    var result = unboundFunc(
                    ...
                    if (result !== -1) SATBUT.showFailMsg(result,
                            "Game_SATBPairs.prototype.pairFuncs " +
                            countdownDatum,
                            "The intervalEntry result of the 1st countdown " +
                            "PairFunc should be -1!");
                }
            }
        }
        if (countdownPairFuncs.length > 1) {
            SATBUT.showFailMsg(countdownDatum,
                    "Game_SATBPairs.prototype.pairFuncs",
                    "The countdown PairFunc list shouldn't have more than 1 " +
                    "PairFuncs!");
        }
    }
...
(function(SATBUT) {
    ...
    // v0.00a - v0.00a; Extended
        var pairFuncs = _GSATBR.chainedRunList.apply(this, arguments);
        // Added to test whether the returned function's valid
        _UT._checkChainedRunList.call(this, list, note, pairFuncs);
        //
        return pairFuncs;
    }; // $.chainedRunList
     ...
     * @param {[PairFunc]} list - The effective notetag list to be chained
     * @param {NoteType} note - The note to have its effective results chained
     * @param {[PairFunc]} pairFuncs - The chained list of PairFuncs to be run
     */
    _UT._checkChainedRunList = function(list, note, pairFuncs) {
        SATBUT.checkFuncs.checkPairFuncList(
                list, "GSATBR.new._checkChainedRunList list");
        SATBUT.checkFuncs.checkNoteType(
                note, "GSATBR.new._checkChainedRunList note");
        SATBUT.checkFuncs.checkPairFuncList(
                pairFuncs, "GSATBR.new._checkChainedRunList pairFuncs");
...
/*----------------------------------------------------------------------------
 *    # (v0.04a+)New class: Sprite_SATBContinuousOrderBattlerIcon
 *      - Tests Sprite_SATBContinuousOrderBattlerIcon precond, postcond,invar
 *----------------------------------------------------------------------------*/
...
(function(SATB, SATBUT) {
    ...
    var SSATBCOBI = SATBUT.Sprite_SATBContinuousOrderBattlerIcon = {
        orig: {},
        new: {}
    };
    var $ = Sprite_SATBContinuousOrderBattlerIcon.prototype;
    var _SSATBCOBI = SSATBCOBI.orig, _UT = SSATBCOBI.new;

    _SSATBCOBI.initialize = $.initialize;
    _UT.initialize = $.initialize = function(battler) {
    // v0.14a - v0.14a; Extended
        _SSATBCOBI.initialize.apply(this, arguments);
        // Added to test the argument of this constructor
        SATBUT.checkFuncs.checkObjType(
                battler, "_SSATBCOBI.initialize battler", Game_Battler);
        //
    }; // $.initialize
    ...
    // v0.14a - v0.14a; Extended
        ...
        if (battler_) SATBUT.checkFuncs.checkObjType(
                battler_, "_SSATBCOBI.initialize battler", Game_Battler);
        //
    }; // $.setBattler
...
(function(SATB, SATBUT) {
    ...
    var WSATBBB = SATBUT.Window_SATBBar = { orig: {}, new: {} };
    var $ = Window_SATBBarBase.prototype;
    var _WSATBBB = WSATBBB.orig, _UT = WSATBBB.new;

    _WSATBBB.initialize = $.initialize;
    _UT.initialize = $.initialize = function(battler) {
    // v0.03a - v0.06a; Extended
        _WSATBBB.initialize.apply(this, arguments);
        // Added to test the argument of this constructor
        SATBUT.checkFuncs.checkObjType(
                battler, "_WSATBBB.initialize battler", Game_Battler);
        //
    }; // $.initialize

    _WSATBBB.setBattler = $.setBattler;
    _UT.setBattler = $.setBattler = function(battler_) {
    // v0.03a - v0.05b; Extended
        _WSATBBB.setBattler.apply(this, arguments);
        // Added to test the argument of this public api
        if (battler_) SATBUT.checkFuncs.checkObjType(
                battler_, "_WSATBBB.initialize battler", Game_Battler);
        //
    }; // $.setBattler

    var funcParamCaches = SATB.Window_SATBBarBase._FUNC_PARAM_CACHES;
    Object.keys(funcParamCaches).forEach(function(funcName) {
        _WSATBBB[funcName] = $[funcName];
        _UT[funcName] = $[funcName] = function() { // v0.04a - v0.14a; Extended
            var val = _WSATBBB[funcName].apply(this, arguments);
            var param = this["_" + funcParamCaches[funcName] + "Param"];
            // Added to check the return result on the call site directly
            SATBUT.checkFuncs[SATBUT.unitTests.params.bar[param]](
                    val, "_WSATBBB." + funcName + " val");
            //
            return val;
        }; // $[funcName]
    });

    _WSATBBB._fillBarW = $._fillBarW;
    _UT._fillBarW = $._fillBarW = function() {
    // v0.03a - v0.03a; Extended
        var fillW = _WSATBBB._fillBarW.apply(this, arguments);
        // Added to check whether the returned result's valid
        _UT._checkFillW.call(this, fillW);
        //
        return fillW;
    }; // $._fillBarW

    _WSATBBB._formattedText = $._formattedText;
    _UT._formattedText = $._formattedText = function() {
    // v0.04a - v0.06a; Extended
        var text = _WSATBBB._formattedText.apply(this, arguments);
        // Added to check the return result on the call site directly
        SATBUT.checkFuncs[SATBUT.unitTests.params.bar[this._textParam]](
                text, "_WSATBBB._formattedText text");
        //
        return text;
    }; // $._formattedText
     ...
     * @param {Number} fillW - The ATB bar fill width
     * @todo Adds useful contexts to the shown fail messages
     */
    _UT._checkFillW = function(fillW) {
        var fillProportion = fillW * 1.0 / this.width;
        ...
        if (this._battler.isSATBCharge()) {
            if (fillProportion < 0) SATBUT.showFailMsg(fillProportion,
                    "WSATBBB.new._checkFillW fillProportion",
...
})(DoubleX_RMMV.SATB, DoubleX_RMMV.SATB.Unit_Tests); // Window_SATBBarBase
 ...
 *      - Tests the Window_SATBForceRunCmd preconds, postconds and invariants
 *----------------------------------------------------------------------------*/
...
(function(SATB, SATBUT) {
    ...
    var funcParamCaches = SATB.Window_SATBBase._FUNC_PARAM_CACHES;
    Object.keys(funcParamCaches).forEach(function(funcName) {
        _WSATBFRC[funcName] = $[funcName];
        _UT[funcName] = $[funcName] = function() { // v0.14a - v0.14a; Extended
            var val = _WSATBFRC[funcName].apply(this, arguments);
            var param = this["_" + funcParamCaches[funcName] + "Param"];
            // Added to check the return result on the call site directly
            SATBUT.checkFuncs[SATBUT.unitTests.params.wait[param]](
                    val, "_WSATBFRC." + funcName + " val");
            //
            return val;
        }; // $[funcName]
    });
 ...
 *      - Tests the Window_SATBForceStopCmd preconds, postconds and invariants
 *----------------------------------------------------------------------------*/
...
(function(SATB, SATBUT) {
    ...
    var funcParamCaches = SATB.Window_SATBBase._FUNC_PARAM_CACHES;
    Object.keys(funcParamCaches).forEach(function(funcName) {
        _WSATBFSC[funcName] = $[funcName];
        _UT[funcName] = $[funcName] = function() { // v0.14a - v0.14a; Extended
            var val = _WSATBFSC[funcName].apply(this, arguments);
            var param = this["_" + funcParamCaches[funcName] + "Param"];
            // Added to check the return result on the call site directly
            SATBUT.checkFuncs[SATBUT.unitTests.params.wait[param]](
                    val, "_WSATBFSC." + funcName + " val");
            //
            return val;
        }; // $[funcName]
    });
 ...
 *      - Tests the Window_SATBForceStatus preconds, postconds and invariants
 *----------------------------------------------------------------------------*/
...
(function(SATB, SATBUT) {
    ...
    var WSATBFS = SATBUT.Window_SATBForceStatus = { orig: {}, new: {} };
    var $ = Window_SATBForceStatus.prototype;
    var _WSATBFS = WSATBFS.orig, _UT = WSATBFS.new;

    var funcParamCaches = SATB.Window_SATBBase._FUNC_PARAM_CACHES;
    Object.keys(funcParamCaches).forEach(function(funcName) {
        _WSATBFS[funcName] = $[funcName];
        _UT[funcName] = $[funcName] = function() { // v0.14a - v0.14a; Extended
            var val = _WSATBFS[funcName].apply(this, arguments);
            var param = this["_" + funcParamCaches[funcName] + "Param"];
            // Added to check the return result on the call site directly
            SATBUT.checkFuncs[SATBUT.unitTests.params.wait[param]](
                    val, "_WSATBFS." + funcName + " val");
            //
            return val;
        }; // $[funcName]
    });

})(DoubleX_RMMV.SATB, DoubleX_RMMV.SATB.Unit_Tests); // Window_SATBForceStatus

/*----------------------------------------------------------------------------
 *    # (v0.13a+)New class: Window_SATBCTB
 *      - Tests Window_SATBCTB preconditions, postconditions and invariants
 *----------------------------------------------------------------------------*/
...
(function(SATB, SATBUT) {
    ...
    var WSATBCTB = SATBUT.Window_SATBCTB = { orig: {}, new: {} };
    var $ = Window_SATBCTB.prototype;
    var _WSATBCTB = WSATBCTB.orig, _UT = WSATBCTB.new;

    var funcParamCaches = SATB.Window_SATBBase._FUNC_PARAM_CACHES;
    Object.keys(funcParamCaches).forEach(function(funcName) {
        _WSATBCTB[funcName] = $[funcName];
        _UT[funcName] = $[funcName] = function() { // v0.14a - v0.14a; Extended
            var val = _WSATBCTB[funcName].apply(this, arguments);
            var param = this["_" + funcParamCaches[funcName] + "Param"];
            // Added to check the return result on the call site directly
            SATBUT.checkFuncs[SATBUT.unitTests.params.ctb[param]](
                    val, "_WSATBCTB." + funcName + " val");
            //
            return val;
        }; // $[funcName]
    });

})(DoubleX_RMMV.SATB, DoubleX_RMMV.SATB.Unit_Tests); // Window_SATBCTB

/*----------------------------------------------------------------------------
 *    # (v0.14a+)New class: Window_SATBContinuousOrder
 *      - Tests Window_SATBContinuousOrder preconds, postconds and invariants
 *----------------------------------------------------------------------------*/
...
(function(SATB, SATBUT) {
    ...
    var WSATBCO = SATBUT.Window_SATBContinuousOrder = { orig: {}, new: {} };
    var $ = Window_SATBContinuousOrder.prototype;
    var _WSATBCO = WSATBCO.orig, _UT = WSATBCO.new;

    _WSATBCO.addActorSprite = $.addActorSprite;
    _UT.addActorSprite = $.addActorSprite = function(actor) {
    // v0.14a - v0.14a; Extended
        _WSATBCO.addActorSprite.apply(this, arguments);
        // Added to test the argument of this public api
        SATBUT.checkFuncs.checkObjType(
                actor, "_WSATBCO.addActorSprite actor", Game_Actor);
        //
    }; // $.addActorSprite

    _WSATBCO.addEnemySprite = $.addEnemySprite;
    _UT.addEnemySprite = $.addEnemySprite = function(enemy) {
    // v0.14a - v0.14a; Extended
        _WSATBCO.addEnemySprite.apply(this, arguments);
        // Added to test the argument of this public api
        SATBUT.checkFuncs.checkObjType(
                enemy, "_WSATBCO.addEnemySprite enemy", Game_Enemy);
        //
    }; // $.addEnemySprite

    _WSATBCO.removeActorSprite = $.removeActorSprite;
    _UT.removeActorSprite = $.removeActorSprite = function(actorId) {
    // v0.14a - v0.14a; Extended
        _WSATBCO.removeActorSprite.apply(this, arguments);
        // Added to test the argument of this public api
        SATBUT.checkFuncs.checkNaturalNum(
                actorId, "_WSATBCO.removeActorSprite actorId");
        //
    }; // $.removeActorSprite

    _WSATBCO.removeEnemySprite = $.removeEnemySprite;
    _UT.removeEnemySprite = $.removeEnemySprite = function(i) {
    // v0.14a - v0.14a; Extended
        _WSATBCO.removeEnemySprite.apply(this, arguments);
        // Added to test the argument of this public api
        SATBUT.checkFuncs.checkNonnegativeInt(
                i, "_WSATBCO.removeEnemySprite i");
        //
    }; // $.removeEnemySprite

    _WSATBCO.transformEnemySprite = $.transformEnemySprite;
    _UT.transformEnemySprite = $.transformEnemySprite = function(enemy) {
    // v0.14a - v0.14a; Extended
        _WSATBCO.transformEnemySprite.apply(this, arguments);
        // Added to test the argument of this public api
        SATBUT.checkFuncs.checkObjType(
                enemy, "_WSATBCO.transformEnemySprite enemy", Game_Enemy);
        //
    }; // $.transformEnemySprite

    var funcParamCaches = SATB.Window_SATBContinuousOrder._FUNC_PARAM_CACHES;
    Object.keys(funcParamCaches).forEach(function(funcName) {
        var cache = funcParamCaches[funcName];
        var param = "continuousOrder" + cache[0].toUpperCase() + cache.slice(1);
        _WSATBCO[funcName] = $[funcName];
        _UT[funcName] = $[funcName] = function() { // v0.14a - v0.14a; Extended
            var val = _WSATBCO[funcName].apply(this, arguments);
            // Added to check the return result on the call site directly
            SATBUT.checkFuncs[SATBUT.unitTests.params.order[param]](
                    val, "_WSATBCO." + funcName + " val");
            //
            return val;
        }; // $[funcName]
    });

    _WSATBCO._isVisible = $._isVisible;
    _UT._isVisible = $._isVisible = function() { // v0.14a - v0.14a; Extended
        var isVisible = _WSATBCO._isVisible.apply(this, arguments);
        // Added to check the return result on the call site directly
        var checkFunc = SATBUT.unitTests.params.order.isShowContinuousOrderWin;
        SATBUT.checkFuncs[checkFunc](
                isVisible, "_WSATBCO._isVisible isVisible");
        //
        return isVisible;
    }; // $._isVisible
 ...
 *      - Test Window_SATBTurnClock precondition, postcondition and invariant
 *----------------------------------------------------------------------------*/
...
(function(SATB, SATBUT) {
    ...
    var WSATBTC = SATBUT.Window_SATBTurnClock = { orig: {}, new: {} };
    var $ = Window_SATBTurnClock.prototype;
    var _WSATBTC = WSATBTC.orig, _UT = WSATBTC.new;
...
})(DoubleX_RMMV.SATB, DoubleX_RMMV.SATB.Unit_Tests); // Window_SATBTurnClock
...
(function(SATBUT) {
    ...
    function testMultiplyTurnClockSec(firstPartyMem) {
        ...
        var max = SATBTurnManager.coreTurnSecClockMax();
        SATBTurnManager.setCoreTurnClockSec(-max);
        SATBTurnManager.multiplyCoreTurnClockSec(-1);
        var turnClockSec = SATBTurnManager.coreTurnSecClock();
        var clockUnit = SATBTurnManager.coreTurnClockUnit();
        var expected = clockUnit === "sec" ? 0 : max;
        if (turnClockSec === expected) return;
        SATBUT.showFailMsg(turnClockSec, "testMultiplyTurnClockSec",
     ...
     * @param {Game_Actor} firstPartyMem - The 1st party member
     */
    function testSetNegativeTurnClockSec(firstPartyMem) {
        console.info("pre testSetNegativeTurnClockSec");
        var negativeMax = -SATBTurnManager.coreTurnSecClockMax();
        SATBTurnManager.setCoreTurnClockSec(negativeMax);
        var turnClockSec = SATBTurnManager.coreTurnSecClock();
        if (turnClockSec === negativeMax) return;
        SATBUT.showFailMsg(turnClockSec, "testSetNegativeTurnClockSec",
                "The battle turn clock second counter should be " +
                negativeMax + "!");
    } // testSetNegativeTurnClockSec
     ...
     * @param {Game_Actor} firstPartyMem - The 1st party member
     */
    function testSetTurnClockSec(firstPartyMem) {
        console.info("pre testSetTurnClockSec");
        var max = SATBTurnManager.coreTurnSecClockMax();
        SATBTurnManager.setCoreTurnClockSec(max);
        var turnClockSec = SATBTurnManager.coreTurnSecClock();
        var clockUnit = SATBTurnManager.coreTurnClockUnit();
        var expected = clockUnit === "sec" ? 0 : max;
        if (turnClockSec === expected) return;
        SATBUT.showFailMsg(turnClockSec, "testSetTurnClockSec",
                "The battle turn clock second counter should be " + expected +
                "!");
    } // testSetTurnClockSec
     ...
     * @param {Game_Actor} firstPartyMem - The 1st party member
     */
    function testAddNegativeTurnClockSec(firstPartyMem) {
        console.info("pre testAddNegativeTurnClockSec");
        var negativeMax = -SATBTurnManager.coreTurnSecClockMax();
        SATBTurnManager.setCoreTurnClockSec(negativeMax);
        SATBTurnManager.addCoreTurnClockSec(negativeMax);
        var turnClockSec = SATBTurnManager.coreTurnSecClock();
        var doubleNegativeMax = negativeMax * 2;
        if (turnClockSec === doubleNegativeMax) return;
        SATBUT.showFailMsg(turnClockSec, "testAddNegativeTurnClockSec",
                "The battle turn clock second counter should be " +
                doubleNegativeMax + "!");
    } // testAddNegativeTurnClockSec
     ...
     * @param {Game_Actor} firstPartyMem - The 1st party member
     */
    function testAddTurnClockSec(firstPartyMem) {
        console.info("pre testAddTurnClockSec");
        var max = SATBTurnManager.coreTurnSecClockMax();
        SATBTurnManager.setCoreTurnClockSec(-max);
        SATBTurnManager.addCoreTurnClockSec(max);
        var turnClockSec = SATBTurnManager.coreTurnSecClock();
        if (turnClockSec === 0) return;
        SATBUT.showFailMsg(turnClockSec, "testAddTurnClockSec",
     ...
     * @param {Game_Actor} firstPartyMem - The 1st party member
     */
    function testAddMaxTurnClockSec(firstPartyMem) {
        console.info("pre testAddMaxTurnClockSec");
        var max = SATBTurnManager.coreTurnSecClockMax();
        SATBTurnManager.setCoreTurnClockSec(-max);
        SATBTurnManager.addCoreTurnClockSec(max * 2);
        var turnClockSec = SATBTurnManager.coreTurnSecClock();
        var clockUnit = SATBTurnManager.coreTurnClockUnit();
        var expected = clockUnit === "sec" ? 0 : max;
        if (turnClockSec === expected) return;
        SATBUT.showFailMsg(turnClockSec, "testAddMaxTurnClockSec",
                "The battle turn clock second counter should be " + expected +
                "!");
    } // testAddMaxTurnClockSec
    ...
    function testSetCoreSATBPluginCmd(firstPartyMem) {
        ...
        interpreter._params[0] = "setCoreSATB allParty 0 " + max;
        interpreter.command356();
    ...
    function testSetCoreSATBProportionPluginCmd(firstPartyMem) {
        ...
        var interpreter = new Game_Interpreter();
        interpreter._params[0] = "setCoreSATBProportion allParty 0 1";
        interpreter.command356();
    ...
    function testAddCoreSATBPluginCmd(firstPartyMem) {
        ...
        var interpreter = new Game_Interpreter();
        var max = firstPartyMem.coreMaxSATB();
        interpreter._params[0] = "addCoreSATB allParty 0 " + max;
        interpreter.command356();
        var cur = firstPartyMem.coreSATB();
    ...
    function testAddCoreSATBProportionPluginCmd(firstPartyMem) {
        ...
        var interpreter = new Game_Interpreter();
        interpreter._params[0] = "addCoreSATBProportion allParty 0 1";
        interpreter.command356();
        var cur = firstPartyMem.coreSATB(), max = firstPartyMem.coreMaxSATB();
        if (cur === max) return;
    ...
    function testMultiplyCoreSATBPluginCmd(firstPartyMem) {
        ...
        var interpreter = new Game_Interpreter();
        interpreter._params[0] = "multiplyCoreSATB allParty 0 -1";
        interpreter.command356();
        var cur = firstPartyMem.coreSATB();
        if (cur === max) return;
    ...
    function testFillUpCoreSATBPluginCmd(firstPartyMem) {
        ...
        var interpreter = new Game_Interpreter();
        interpreter._params[0] = "fillUpCoreSATB allParty 0";
        interpreter.command356();
        var cur = firstPartyMem.coreSATB(), max = firstPartyMem.coreMaxSATB();
    ...
    function testClearCoreSATBPluginCmd(firstPartyMem) {
        ...
        var interpreter = new Game_Interpreter();
        interpreter._params[0] = "clearCoreSATB allParty 0";
        interpreter.command356();
        var cur = firstPartyMem.coreSATB();
    ...
    function testSetSATBActTimesPluginCmd(firstPartyMem) {
        ...
        var interpreter = new Game_Interpreter();
        interpreter._params[0] = "setSATBActTimes allParty 0 1";
        interpreter.command356();
    ...
    function testAddSATBActTimesPluginCmd(firstPartyMem) {
        ...
        var interpreter = new Game_Interpreter();
        interpreter._params[0] = "addSATBActTimes allParty 0 1";
        interpreter.command356();
        var cur = firstPartyMem.satbActTimes();
    ...
    function testMultiplySATBActTimesPluginCmd(firstPartyMem) {
        ...
        var interpreter = new Game_Interpreter();
        interpreter._params[0] = "multiplySATBActTimes allParty 0 2";
        interpreter.command356();
        var cur = firstPartyMem.satbActTimes();
        if (cur === 4) return;
